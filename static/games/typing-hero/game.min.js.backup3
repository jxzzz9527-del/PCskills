    ...
    return function(n) {
        ...
        function startGame() {
            ...
            if (startScreen && gameWrapper) {
                ...
                console.log('玩家圖片載入狀態:', i.complete);
                console.log('敵機圖片載入狀態:', r[0] ? r[0].complete : 'undefined');
                
                // 等待圖片載入完成後開始遊戲
                const checkImagesLoaded = () => {
                    if (i.complete && r[0] && r[0].complete) {
                        console.log('所有圖片載入完成，開始遊戲');
        ...
        var L = function() {
            function n() {
                ...
                this.setBestScore(t ? parseInt(t) : 0), this.protect = 2, this.isClear = !1, this.clearPer = 15, this.clearIndex = 0, this.clearMax = 600, this.tailY = this.y + this.h / 2 - 6, this.fireAni = new q({
                    ctx: c.ctx,
                    host: this,
                    img: u,
                    pos: function(n) {
            ...
            return t = n, (e = [{
                ...
                key: "restart",
                value: function() {
                    this.setLetterNum(0), this.setScore(0), this.setProtect(2), this.err_i = -1, this.deg = 0, this.target = null, this.isClear = !1, this.clearIndex = 0, this.clearPer = 15, this.clearMax = 600
                }
        ...
        _.a.use(X.a), window.J = l.a, l.a.ready((function() {
            l.a.isMobile() && (z = 15, function(n, t) {
                ...
                function() {
                    ...
                    i.onload = function() { console.log('玩家圖片載入完成'); };
                    i.onerror = function() { console.log('玩家圖片載入失敗'); };
                    console.log('玩家圖片路徑:', i.src);
                    // o is now global
