! function(n, t) {
    ...
    return function(n) {
        ...
        var v = function() {
            ...
            return t = n, (e = [{
                ...
                value: function() {
                    ...
                    return c.player && c.player.setErr(), m("沒有找到目標", !0, 1e3), null
                }
            }, {
                key: "touchTarget",
                value: function() {
        ...
        function J(n) {
            c.enemys.length > 0 ? c.bullets.append(new v(n)) : (m("沒有找到目標", !0, 1e3), c.player && c.player.setErr())
        }
        ...
        window.onkeydown = function(n) {
            ...
            if (c.isPause) {
                ...
                if (bopomofoKeyboard.isValidKey(key)) {
                    ...
                    c.player && c.player.clear();
                } else {
                    // 無效按鍵 - 顯示錯誤訊息
                    m("按鍵錯誤", !0, 1e3);
                    c.player && c.player.setErr();
                }
            }
        }, window.onresize = function() {
            if (!c || !c.canvas || !c.ctx || !c.player) return;
...
// Share版本：已移除個人最高分功能
function fetchAndDisplayPersonalBest(currentScore) {}
