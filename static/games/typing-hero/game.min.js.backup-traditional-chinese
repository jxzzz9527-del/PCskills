! function(n, t) {
    ...
    return function(n) {
        ...
        var questionBank = {
            ...
            level3: [
                { word: "耳目一新", bopomofo: "ㄦˇ ㄇㄨˋ ㄧˊ ㄒㄧㄣ" },
