! function(n, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("game", [], t) : "object" == typeof exports ? exports.game = t() : n.game = t()
}(this, (function() {
    return function(n) {
        var t = {};
        ...
        n.exports = function(n) {
            ...
            function o(n) {
                ...
                var t = on.type(n);
                return "function" == t ? n : "string" == t ? new Function(n) : function() {}
            }
            e.r(t);
            var r, h = function() {
                var n = [],
                ...
                function e(e) {
                    if (!t && ("onreadystatechange" !== e.type || "complete" === document.readyState)) {
                        for (var i = 0; i < n.length; i++) n[i].call(document);
                        t = !0, n = null
                    }
                }
                return document.addEventListener ? (document.addEventListener("DOMContentLoaded", e, !1), document.addEventListener("readystatechange", e, !1), window.addEventListener("load", e, !1)) : document.attachEvent && (document.attachEvent("onreadystatechange", e), window.attachEvent("onload", e)),
                    function(e) {
            ...
            function s(n) {
                var t = on.id("jCopyInput");
                return t.exist() || (t = on.ct("input").attr({
                    type: "text",
                    id: "jCopyInput"
                }), on.body().append(t)), t.val(n).select(), !!document.execCommand("Copy") || (alert("Copy is not supported in your browser"), !1)
            }
            ...
            function a(n, t) {
                if (null == t || "boolean" == on.type(t)) return n;
                var e = null;
                switch (t) {
                    case "date":
                        var i;
                        "date" == on.type(n) ? e = n : (i = n.has("-") ? n.split("-") : n.split("/"), e = new Date(i[0], i[1], i[2]));
                        break;
                    case "length":
                        e = n.length;
                        break;
                    case "headLetter":
                        e = n.toLowerCase().charCodeAt(0);
                        break;
                    case "number":
                    default:
                        e = n
            ...
            function l(n) {
                ...
                var t = on.type(n);
                if ("htmlelement" == t || "array" == t) return n.clone();
                if ("json" == t || "object" == t) {
                    var e = new Object;
                    for (var i in n) null == n[i] || null == n[i] ? e[i] = n[i] : "array" == on.type(n[i]) ? e[i] = n[i].clone() : "json" == on.type(n[i]) || "object" == on.type(n[i]) ? e[i] = l(n[i]) : e[i] = n[i];
                    return e
                }
                return n
            }
            ...
            function g(n, t) {
                ...
                var e = on.type(n);
                if (e != on.type(t)) return !1;
                if ("json" == e || "object" == e) return JSON.stringify(n) == JSON.stringify(t);
                if ("array" == e || "function" == e) return n.toString() == t.toString();
                if ("htmlelement" == e || "htmlcollection" == e || "nodelist" == e) {
                    var i = n.allHtml();
                    return "array" == on.type(i) ? g(i, t.allHtml()) : i == t.allHtml()
                }
                return n == t
            }
            ...
            function p(n) {
                return null == n || null == n ? on.ct("div").findClass("a") : 1 == n.length ? n[0] : n
            }

            function d(n, t, e) {
                if (e.has("-=") || e.has("+=")) {
                    var i, o = f(e.substring(e.indexOf("=") + 1));
                    return e.has("-=") && (o[0] = -o[0]), i = e.has("%") ? f(n.style[t]) : f(getComputedStyle(n)[t]), o[0] + i[0] + o[1]
                }
                return e
            }

            function f(n, t) {
                if ("" != n && null != n || (n = "0%"), null == t)
                    if (n.has("px")) t = "px";
                    else if (n.has("%")) t = "%";
                else {
                    if (!n.has("em")) return [parseFloat(n), "px"];
                    t = "em"
                }
                return [parseFloat(n.substring(0, n.indexOf(t))), t]
            }

            function y(n) {
                if ("string" == on.type(n)) switch (n) {
                    case "slower":
                        n = 1500;
                        break;
                    case "slow":
            ...
            function z(n) {
                "true" == n.attr("jet-ispw") && n.attr("type", "password")
            }

            function v() {
                on.id("jetInputWrapper").exist() && (on.id("jetInputWrapper").css("top", "-100%"), setTimeout((function() {
                    on.id("jetInputContent").empty()
                }), 300))
            }

            function w(n, t, e, i) {
                1 == arguments.length ? (t = n.def, e = n.valid, i = n.placeholder, n = on.checkArg(n.text, "CHINESE" == on.language ? "请输入：" : "Please input:")) : n = on.checkArg(n, "CHINESE" == on.language ? "请输入：" : "Please input:"), on.id("jetInputContent").append(on.ct("div").addClass("jet-input-text").txt(n));
                var o = on.ct("input.jet-input[type=text]");
                null != t && o.val(t), null != e && o.attr("jet-valid", e), null != i && o.attr("placeholder", i), on.id("jetInputContent").append(o)
            }

            function k(n) {
                return "string" == on.type(n) ? on.select("[jet-form=" + n + "]") : n
            }
            ...
            function q(n) {
                var t = "",
                    e = n.attr("jet-get"),
                    i = "";
                switch (null != e && e.has(":") && (i = e.split(":")[1], e = e.split(":")[0]), e) {
                    case "allHtml":
                        t = n.allHtml();
                        break;
                    case "html":
            ...
            function C(n) {
                return n.hasClass("jet-unpass") ? n.attr("jet-value") : n.content()
            }

            function T(n, t) {
                var e = n.attr("jet-valid"),
                    i = "";
                if (null != e) {
                    if (-1 != e.indexOf("lengthOfAny")) {
                        var o = e.substring(12, e.length - 1).split(","),
                            r = n.content();
                        i = r.length >= parseInt(o[0]) && r.length <= parseInt(o[1]) ? "true" : E("lengthOfAny", o)
                    } else i = function(n, t) {
                        if (-1 != n.indexOf("notnull")) {
                            if (0 == t.length) return M("notnull")
                        } else if (-1 != n.indexOf("null")) {
                            var e = n.split(" "),
                                i = "null" == e[0] ? e[1] : e[0];
                            if (-1 != i.indexOf("range")) {
                                var o = A(n, t);
                                if ("true" != o && "" != t) return o
                            }
                            if (!H(i).test(t) && "" != t) return M(i)
                        } else if (-1 != n.indexOf("range")) {
                            var r = A(n, t);
                            if ("true" != r) return r
                        } else if (!H(n).test(t)) return M(n);
                        return "true"
                    }(e, n.content());
                    "true" == i ? (on.useDefaultStyle && (n.removeClass("jet-unpass").attr("jet-value", ""), z(n)), null != b && b(n, i)) : (on.useDefaultStyle && (n.attr("jet-value", n.content()).content(i).addClass("jet-unpass"), "password" == n.attr("type") && n.attr("jet-ispw", "true").attr("type", "text")), null != x && x(n, i), on.useShowForValid && 0 != t && on.show(i, "error"))
                }
                return i
            }
            ...
            function L(n, t, e) {
                ...
                null == e && (r = !1);
                var h = !0;
                if (n.select("[jet-valid]").each((function(n) {
                        var t = function(n) {
                            return n.hasClass("jet-unpass") ? (null != x && x(n, n.val()), n.val()) : T(n, !1)
                        }(n);
                        "true" != t && (h = !1, r && (i[i.length] = {
                            obj: n,
                            error: t
                        }))
                    })), h) null != t && o(t)(n.get(), n);
                else {
                    r && o(e)(i, n);
                    var s = "CHINESE" == on.language ? "输入有误，请按提示改正。" : "Values is not expected";
                    on.useShowForValid && on.show(s, "error")
                }
            }
            var S = {
                    nul: "*可以为空",
            ...
            function M(n) {
                var t = 0;
                if (-1 != n.indexOf("range") ? t = 6 : -1 != n.indexOf("letterStart") ? t = 12 : (-1 != n.indexOf("length") || n.has("number") && "number" != n) && (t = 7), 0 != t) {
                    var e = n.substring(t, n.length - 1).split(",");
                    return null == e[1] && (e[1] = e[0]), E(n.substring(0, t - 1), e)
                }
                return E(n)
            }

            function E(n, t) {
                if ("CHINESE" == on.language) {
                    if (null == t) return S[n];
                    var e = "";
                    return n.has("number") && (e = " 且长度为"), S[n] + e + "[" + t[0] + "," + t[1] + "]"
                }
                if (null == t) return N[n];
                var i = "";
                return n.has("number") && (i = " and length between"), N[n] + i + "[" + t[0] + "," + t[1] + "]"
            }

            function H(n) {
                var t = -1,
                    e = -1;
                if (-1 != n.indexOf("length")) {
                    var i = n.substring(7, n.length - 1).split(",");
                    n = "length", t = i[0], null == i[1] && (i[1] = i[0]), e = i[1]
                } else if (-1 != n.indexOf("letterStart")) {
                    var o = n.substring(12, n.length - 1).split(",");
                    n = "letterStart", t = o[0], null == o[1] && (o[1] = o[0]), e = o[1]
                } else if (n.has("number") && "number" != n) {
                    var r = n.substring(7, n.length - 1).split(",");
                    n = "number", t = r[0], null == r[1] && (r[1] = r[0]), e = r[1]
                } else n.has("express") && (t = n.substring(8, n.length - 1), n = "express");
                switch (n) {
                    case "null":
                        return /^\S{0}$/;
                    case "date":
                    ...
                    case "phone":
                        return /^([1]\d{10})$/;
                    case "letterStart":
                        return new RegExp("^([a-zA-Z]([a-zA-Z\\d]){" + (parseInt(t) - 1) + "," + (parseInt(e) - 1) + "})$");
                    case "length":
                        return new RegExp("^(([a-zA-Z\\d]){" + t + "," + e + "})$");
                    case "express":
                        return new RegExp(t);
                    default:
                        return "null"
            ...
            function A(n, t) {
                var e = n.substring(6, n.length - 1).split(",");
                return H(n = "number").test(t) ? parseInt(t) < parseInt(e[0]) || parseInt(t) > parseInt(e[1]) ? E("range", e) : "true" : E("number")
            }

            function I(n, t, e, i, o) {
                clearTimeout(r);
                var h = on.id("jetNoteWrapper");
                h.exist() || (function() {
                    var n = on.ct("div").attr({
                        id: "jetNoteWrapper",
                        "jet-style": on.noteStyleStr,
                        onclick: "J.close()"
                    });
                    "simple" != on.noteStyleStr && n.append(X()), on.body().append(n)
                }(), h = on.id("jetNoteWrapper"));
                var s = on.noteStyleStr;
                if ("simple" != s) {
                    var u = h.findClass("jet-icon-circle").child();
                    if (t) switch (t) {
                        case "success":
                            u[0].className = "jet-icon-part-ok1 jet-rotate-45", u[1].className = "jet-icon-part-ok2 jet-rotate-45";
                            break;
                        case "warn":
                            u[0].className = "jet-icon-part-bar jet-icon-part-warn1", u[1].className = "jet-icon-part-block jet-icon-part-warn2";
                            break;
                        case "error":
                            u[0].className = "jet-icon-part-x jet-rotate-45", u[1].className = "jet-icon-part-x jet-rotate-045";
                            break;
                        case "info":
                            u[0].className = "jet-icon-part-block jet-icon-part-info1", u[1].className = "jet-icon-part-bar jet-icon-part-info2";
                            break;
                        default:
                            u[0].className = "jet-icon-part-ok1 jet-rotate-45", u[1].className = "jet-icon-part-ok2 jet-rotate-45"
                    } else u[0].className = "jet-icon-part-ok1 jet-rotate-45", u[1].className = "jet-icon-part-ok2 jet-rotate-45", t = "success";
                    on.id("jetNoteContent").txt(n)
                } else on.id("jetNoteWrapper").txt(n);
                if (h.className = "jet-" + t, setTimeout((function() {
                        "simple" == s ? (h.css("top", "0"), setTimeout((function() {
                            h.css("opacity", "1")
                        }), 10)) : "center" == s ? (h.css("top", "50%"), setTimeout((function() {
                            h.addClass("jet-jumpout")
                        }), 10)) : ("0" == h.css("opacity") && h.css("opacity", "1"), h.css("top", "0"))
                    }), 0), e = on.checkArg(e, 1500), "string" == on.type(e)) switch (e) {
                    case "slower":
                        e = 2500;
                        break;
                    case "slow":
            ...
            function O() {
                on.id("jetNoteWrapper").exist() && ("simple" == on.noteStyleStr ? (on.id("jetNoteWrapper").css("opacity", "0"), setTimeout((function() {
                    on.id("jetNoteWrapper").css("top", "-100%")
                }), 550)) : "center" == on.noteStyleStr ? on.id("jetNoteWrapper").addClass("jet-jumpoff") : on.id("jetNoteWrapper").css("top", "-100%"))
            }
            var W = null,
                _ = null;

            function P() {
                on.id("jetConfirmWrapper").exist() && on.id("jetConfirmWrapper").css("top", "-100%")
            }

            function X() {
                var n = on.ct("span").addClass("jet-icon-circle").append([on.ct("span"), on.ct("span")]);
                return [on.ct("div").attr("id", "jetNoteIcon").addClass("jet-icon-wrapper").append(n), on.ct("div").attr("id", "jetNoteContent")]
            }

            function V(n, t) {
                if (0 == n.length) {
                    if (0 != t) throw new Error("空数组不支持该方法");
                    return !1
                }
                return !0
            }
            ...
            function R(n, t, e, i, o, r) {
                return n.addClass("j-animation"), setTimeout((function() {
                    o = Q(n, o, r), n.css({
                        transform: "scale(" + t + "," + e + ")",
                        "-ms-transform": "scale(" + t + "," + e + ")",
                        "-webkit-transform": "scale(" + t + "," + e + ")",
                        "-o-transform": "scale(" + t + "," + e + ")",
                        "-moz-transform": "scale(" + t + "," + e + ")"
                    }), setTimeout((function() {
                        D(i, n), $(n)
                    }), o)
                }), 50), n
            ...
            function J(n, t, e, i, o, r) {
                r.css({
                    animation: "j-spin " + n + "s " + o + " 0s " + t,
                    "-moz-animation": "j-spin " + n + "s " + o + " 0s " + t,
                    "-webkit-animation": "j-spin " + n + "s " + o + " 0s " + t,
                    "-o-animation": "j-spin " + n + "s " + o + " 0s " + t
                }), "number" == on.type(t) && null != i && setTimeout((function() {
                    D(i, r)
                }), n * t * 1e3)
            }
            ...
            function F(n, t, e, i, o) {
                o.css({
                    animation: "j-twinkle " + n + "s " + i + " 0s " + t,
                    "-moz-animation": "j-twinkle " + n + "s " + i + " 0s " + t,
                    "-webkit-animation": "j-twinkle " + n + "s " + i + " 0s " + t,
                    "-o-animation": "j-twinkle " + n + "s " + i + " 0s " + t
                }), "number" == on.type(t) && null != e && setTimeout((function() {
                    D(e, o)
                }), n * t * 1e3)
            }
            ...
            function Y(n) {
                return "none" != n.css("display")
            }

            function Z(n, t, e, i, o) {
                return "" == n.style.height || "auto" == n.style.height ? (o && "none" == n.css("display") && n.addClass("j-none"), n.css("height", n.css("height")), n.removeClass("j-none"), n.attr("j-h-auto", "true"), setTimeout((function() {
                    G(n, "j-slide", t, e, i, o)
                }), 50)) : G(n, "j-slide", t, e, i, o), n
            }

            function G(n, t, e, i, o, r) {
                return null == r && (r = !!n.hasAttr("j-display")), n.addClass("j-animation"), r && ("none" == n.css("display") && n.addClass(t), n.show(!1)), 0 != r ? setTimeout((function() {
                    K(n, t, e, i, o, r)
                }), 50) : K(n, t, e, i, o, r), n
            }

            function K(n, t, e, i, o, r) {
                i = Q(n, i, o), r ? ("j-slide" == t && n.addClass("j-over-hidden"), n.removeClass(t)) : n.addClass(t), setTimeout((function() {
                    D(e, n), $(n), r ? "j-slide" == t && (n.removeClass("j-over-hidden"), "true" == n.attr("j-h-auto") && n.css("height", "auto")) : n.hide()
                }), i)
            }

            function Q(n, t, e) {
                return t = null != t ? y(t) / 1e3 : .5, n.css({
                    "transition-duration": t + "s!important",
                    "-ms-transition-duration": t + "s!important",
                    "-webkit-transition-duration": t + "s!important",
                    "-o-transition-duration": t + "s!important",
                    "-moz-transition-duration": t + "s!important"
                }), e = c(e, "linear"), n.css({
                    "transition-timing-function": e + "!important",
                    "-ms-transition-timing-function": e + "!important",
                    "-webkit-transition-timing-function": e + "!important",
                    "-o-transition-timing-function": e + "!important",
                    "-moz-transition-timing-function": e + "!important"
                }), 1e3 * t
            }

            function nn(n) {
                if ("string" == on.type(n)) {
                    var t = on.ct("div").html(n);
                    return 1 == t.child().length ? t.child(0) : t.child().toArray()
                }
                return n
            }

            function tn(n, t, e) {
                document.addEventListener ? n.addEventListener(t.substring(2), o(e), !1) : document.attachEvent && n.attachEvent(t, o(e))
            }
            Array.prototype.each = function(n, t) {
                for (var e = 0; e < this.length; e++) n(this[e], e, t);
                return this
            }, Array.prototype.empty = function() {
                return this.length = 0, this
            }, Array.prototype.remove = function(n, t) {
                var e = this.indexOf(n);
                return 0 == t ? this[e] = this[this.length--] : this.removeByIndex(e), this
            }, Array.prototype.removeByIndex = function(n) {
                return this.splice(n, 1), this
            }, Array.prototype.insert = function(n, t) {
                return this.splice(t, 0, n), this
            }, Array.prototype.insertArray = function(n, t) {
                for (var e = t, i = n.length, o = this.length - 1; o >= e; o--) this[o + i] = this[o];
                for (var r = 0; r < i; r++) this[e + r] = n[r];
                return this
            }, Array.prototype.append = function() {
                return Array.prototype.push.apply(this, arguments), this
            }, Array.prototype.appendArray = function(n) {
                return Array.prototype.push.apply(this, n), this
            }, Array.prototype.prepend = function(n) {
                return 1 == arguments.length ? this.insert(n, 0) : this.insertArray(arguments, 0)
            }, Array.prototype.prependArray = function(n) {
                return this.insertArray(n, 0)
            }, Array.prototype.sort = function(n) {
                for (var t, e, i = this.length, o = 1; o < i; o++) {
                    for (t = o - 1, e = this[o]; t >= 0 && this[t] > e;) this[t + 1] = this[t], t--;
                    this[t + 1] = e
                }
                return 0 == n && this.reverse(), this
            }, Array.prototype.sortByAttr = function(n, t, e) {
                for (var i, o, r = this.length, h = 1; h < r; h++) {
                    for (i = h - 1, o = this[h]; i >= 0 && u(this[i][n], o[n], t);) this[i + 1] = this[i], i--;
                    this[i + 1] = o
                }
                return 0 != t && 0 != e || this.reverse(), this
            ...
            }, Array.prototype.sum = function(n, t) {
                if (V(this)) {
                    if (null != n) return this.slice(n, t).sum();
                    var e = on.type(this[0]);
                    if ("number" == e || "string" == e || "array" == e) {
                        var i;
                        if ("number" == e || "array" == e && "number" == on.type(this[0][0])) i = 0;
                        else {
                            if ("string" != e && ("array" != e || "string" != on.type(this[0][0]))) throw new Error("sum方法不支持除Number,String,Array以外的类型");
                            i = ""
                        }
                        return this.each((function(n) {
                            "array" == on.type(n) ? n.each((function(n) {
                                i += n
                            })) : i += n
                        })), i
                    }
                ...
                if (V(this)) {
                    var n = on.type(this[0]);
                    if ("number" == n || "string" == n) return this.sum() / this.length;
                    throw new Error("ave方法不支持除Number,String以外的类型")
                }
            }, Array.prototype.max = function(n) {
                if (V(this)) {
                    var t = on.type(this[0]);
                    if ("number" == t) return Math.max.apply(null, this);
                    if ("string" == t || "array" == t) return on.clone(this).sortByAttr("length").last();
                    if ("date" == t) return on.clone(this).sort().last();
                    if ("json" == t || "object" == t) {
                        if (null == n) throw new Error("Object类型数组参数不可为空");
                        return on.clone(this).sortByAttr(n, t).last()
                    }
                ...
                if (V(this)) {
                    var t = on.type(this[0]);
                    if ("number" == t) return Math.min.apply(null, this);
                    if ("string" == t || "array" == t) return on.clone(this).sortByAttr("length").first();
                    if ("date" == t) return on.clone(this).sort().first();
                    if ("json" == t || "object" == t) {
                        if (null == n) throw new Error("Object类型数组参数不可为空");
                        return on.clone(this).sortByAttr(n, t).first()
                    }
                    throw new Error("不支持的类型")
                }
            }, Array.prototype.reverse = function() {
                for (var n, t = Math.floor(this.length / 2), e = 0; e < t; e++) n = this[e], this[e] = this[this.length - 1 - e], this[this.length - 1 - e] = n;
                return this
            }, Array.prototype.has = function(n) {
                if (!V(this, !1)) return !1;
                var t = on.type(this[0]);
                if ("number" == t || "string" == t) return this.indexOf(n) > -1;
                for (var e = 0; e < this.length; e++) return n == this[e]
            }, Array.prototype.indexsOf = function(n) {
                var t = [];
                if (V(this, !1))
                    for (var e = 0; e < this.length; e++) n == this[e] && t.push(e);
                return t
            }, Array.prototype.timeOf = function(n) {
                var t = 0;
                return this.each((function(e) {
                    e == n && t++
                })), t
            }, Array.prototype.group = function(n) {
                for (var t = [], e = Math.ceil(this.length / n), i = 0; i < e; i++) {
                    for (var o = [], r = 0; r < n && i * n + r != this.length; r++) o.push(this[i * n + r]);
                    t.push(o)
                }
                return t
            }, HTMLElement.prototype.css = function(n, t) {
                if (null == t) {
                    if ("json" == on.type(n)) {
                        for (var e in n) n[e].has("!important") ? this.style.setProperty(e, d(this, e, n[e].substring(0, n[e].indexOf("!important"))), "important") : this.style.setProperty(e, d(this, e, n[e]));
                        return this
                    }
                    return getComputedStyle(this)[n]
                }
                return t.has("!important") ? this.style.setProperty(n, d(this, n, t.substring(0, t.indexOf("!important"))), "important") : this.style.setProperty(n, d(this, n, t)), this
            }, HTMLCollection.prototype.css = NodeList.prototype.css = function(n, t) {
                if (null == t && "json" != on.type(n)) {
                    var e = [];
                    return this.each((function(t) {
                        e.append(t.css(n))
                    })), e
            ...
            }, HTMLElement.prototype.hasData = function(n) {
                return n in this.j_data
            }, HTMLElement.prototype.data = function(n, t) {
                if (0 == arguments.length) return null != this.j_data ? this.j_data : null;
                if (1 == arguments.length) {
                    if (null == n) return this.j_data = void 0, this;
                    if ("json" == on.type(n)) {
                        if (null != this.j_data)
                            for (var e in n) null != n[e] ? this.j_data[e] = n[e] : delete this.j_data[e];
                        else this.j_data = n;
                        return this
                    }
                    return null != this.j_data ? this.j_data[n] : void 0
                }
                if (null == t) return null != this.j_data && ("array" == on.type(n) ? n.each((function(n) {
                    delete this.j_data[n]
                })) : delete this.j_data[n]), this;
                if (null != this.j_data) this.j_data[n] = t;
                else {
                    var i = {};
                    i[n] = t, this.j_data = i
                }
                return this
            }, HTMLCollection.prototype.data = NodeList.prototype.data = function(n, t) {
                if (null == t && "json" != on.type(n) && null != n) {
                    var e = [];
                    return this.each((function(t) {
                        e.append(t.data(on.clone(n)))
                    })), e
                }
                return null == t ? this.each((function(t) {
                    t.data(on.clone(n))
                })) : this.each((function(e) {
                    e.data(on.clone(n), t)
                })), this
            }, HTMLElement.prototype.attr = function(n, t) {
                if (null == t) {
                    if ("json" == on.type(n)) {
                        for (var e in n) this.setAttribute(e, n[e]);
                        return this
                    }
                    return this.getAttribute(n)
                }
                return this.setAttribute(n, t), this
            }, HTMLCollection.prototype.attr = NodeList.prototype.attr = function(n, t) {
                if (null == t && "json" != on.type(n)) {
                    var e = [];
                    return this.each((function(t) {
                        e.append(t.attr(n))
            ...
            }, HTMLElement.prototype.removeAttr = function(n) {
                var t = n.split(" ");
                if (t.length > 1) {
                    var e = this;
                    t.each((function(n) {
                ...
                return this
            }, HTMLCollection.prototype.removeAttr = NodeList.prototype.removeAttr = function(n) {
                return this.each((function(t) {
                    t.removeAttr(n)
                })), this
            }, HTMLElement.prototype.findClass = function(n) {
                return p(this.getElementsByClassName(n))
            }, HTMLCollection.prototype.findClass = NodeList.prototype.findClass = Array.prototype.findClass = function(n) {
                var t = [];
                return this.each((function(e) {
                    e.hasClass(n) && t.push(e)
                })), 1 == t.length ? t[0] : t
            }, HTMLElement.prototype.findId = function(n) {
                return on.id(n)
            }, HTMLCollection.prototype.findId = NodeList.prototype.findId = Array.prototype.findId = function(n) {
                var t = [];
                return this.each((function(e) {
                    e.attr("id") == n && t.push(e)
                })), 1 == t.length ? t[0] : t
            }, HTMLElement.prototype.findTag = function(n) {
                return p(this.getElementsByTagName(n))
            }, HTMLCollection.prototype.findTag = NodeList.prototype.findTag = Array.prototype.findTag = function(n) {
                var t = [];
                return this.each((function(e) {
                    e.tagName.toLowerCase() == n && t.push(e)
                })), 1 == t.length ? t[0] : t
            }, HTMLElement.prototype.findAttr = function(n) {
                return p(this.querySelectorAll("[" + n + "]"))
            }, HTMLCollection.prototype.findAttr = NodeList.prototype.findAttr = Array.prototype.findAttr = function(n) {
                var t = [];
                return 1 == (n = n.split("=")).length ? this.each((function(e) {
                    e.hasAttr(n[0]) && t.push(e)
                })) : this.each((function(e) {
                    e.attr(n[0]) == n[1] && t.push(e)
                })), 1 == t.length ? t[0] : t
            }, HTMLElement.prototype.findName = function(n) {
                return p(this.querySelectorAll("[name=" + n + "]"))
            }, HTMLCollection.prototype.findName = NodeList.prototype.findName = Array.prototype.findName = function(n) {
                var t = [];
                return this.each((function(e) {
                    e.attr("name") == n && t.push(e)
                })), 1 == t.length ? t[0] : t
            }, HTMLElement.prototype.select = function(n) {
                return p(this.querySelectorAll(n))
            }, HTMLCollection.prototype.select = NodeList.prototype.select = Array.prototype.select = function(n) {
                var t = [];
                return this.each((function(e) {
                    for (var i = e.parent().select(n), o = 0; o < i.length; o++)
                        if (i[o] == e) {
                            t.push(e);
                            break
                        }
                ...
                } else on.html5() ? this.classList.add(n) : this.hasClass(n) || (this.className += " " + n);
                return this
            }, HTMLCollection.prototype.addClass = NodeList.prototype.addClass = function(n) {
                return this.each((function(t) {
                    t.addClass(n)
                })), this
            }, HTMLElement.prototype.replaceClass = function(n, t) {
                return this.hasClass(n) && this.addClass(t).removeClass(n), this
            }, HTMLCollection.prototype.replaceClass = NodeList.prototype.replaceClass = function(n, t) {
                return this.each((function(e) {
                    e.replaceClass(n, t)
                })), this
            }, HTMLElement.prototype.removeClass = function(n) {
                if (null == n) this.className = "";
                else if (n.has(" ")) {
                    var t = n.split(" "),
                        e = this;
                    t.each((function(n) {
                ...
                } else if (on.html5()) this.classList.remove(n);
                else if (this.hasClass(n)) {
                    var i = new RegExp("(\\s|^)" + n + "(\\s|$)");
                    this.className = this.className.replace(i, " ").trim()
                }
                return this
            }, HTMLCollection.prototype.removeClass = NodeList.prototype.removeClass = function(n) {
                return this.each((function(t) {
                    t.removeClass(n)
                })), this
            }, HTMLElement.prototype.toggleClass = function(n) {
                var t = this;
                return n.has(" ") ? n.split(" ").each((function(n) {
                    t.toggleClass(n)
                })) : on.html5() ? this.classList.toggle(n) : t.hasClass(n) ? t.removeClass(n) : t.addClass(n), this
            }, HTMLCollection.prototype.toggleClass = NodeList.prototype.toggleClass = function(n) {
                return this.each((function(t) {
                    t.toggleClass(n)
                })), this
            }, HTMLCollection.prototype.indexOf = NodeList.prototype.indexOf = function(n) {
                for (var t = 0; t < this.length; t++)
                    if (this[t] == n) return t;
                return -1
            }, HTMLElement.prototype.val = function(n) {
                return null == n && 0 == arguments.length ? this.value : ("INPUT" != this.tagName && "TEXTAREA" != this.tagName && "SELECT" != this.tagName || (this.value = c(n, "")), this)
            }, HTMLCollection.prototype.val = NodeList.prototype.val = function(n) {
                if (null == n) {
                    var t = [];
                    return this.each((function(n) {
                        t.append(n.val())
            ...
            }, HTMLElement.prototype.txt = function(n) {
                return null == n && 0 == arguments.length ? this.innerText : (this.innerText = c(n, ""), this)
            }, HTMLCollection.prototype.txt = NodeList.prototype.txt = function(n) {
            ...
            }, HTMLElement.prototype.content = function(n) {
                if ("INPUT" == this.tagName || "TEXTAREA" == this.tagName || "SELECT" == this.tagName) {
                    if (null == n && 0 == arguments.length) return this.value;
                    try {
                        this.value = c(n, "")
                    } catch (n) {}
                } else {
                    if (null == n && 0 == arguments.length) return this.innerText;
                    this.innerText = c(n, "")
                }
                return this
            }, HTMLCollection.prototype.content = NodeList.prototype.content = function(n) {
                if (null == n) {
                    var t = [];
                    return this.each((function(n) {
                        t.append(n.content())
                ...
                return s(this.html())
            }, HTMLElement.prototype.html = function(n) {
                return null == n ? this.innerHTML : (this.innerHTML = n, this)
            }, HTMLCollection.prototype.html = NodeList.prototype.html = function(n) {
                if (null == n) {
                    var t = [];
                    return this.each((function(n) {
                        t.append(n.html())
            ...
            }, HTMLElement.prototype.allHtml = function(n) {
                if (null == n) return on.ct("div").append(this.clone()).html();
                var t = this.index(),
                    e = this.parent().append(n, t);
                return this.remove(), e.child(t)
            }, HTMLCollection.prototype.allHtml = NodeList.prototype.allHtml = function(n) {
                var t = [];
                return this.each((function(e) {
                    t.append(e.allHtml(n))
                })), t
            }, HTMLElement.prototype.hasClass = function(n) {
                return on.html5() ? this.classList.contains(n) : new RegExp("(\\s|^)" + n + "(\\s|$)").test(this.className)
            }, HTMLElement.prototype.next = function(n) {
                return null != n ? this.parent().child(this.index() + n) : this.parent().child(this.index() + 1)
            }, HTMLElement.prototype.prev = function(n) {
                return null != n ? this.parent().child(this.index() - n) : this.parent().child(this.index() - 1)
            ...
            }, HTMLElement.prototype.scrollTo = function(n, t, e) {
                var i = 0,
                    o = this,
                    r = y(e = c(e, 400)) / 10,
                    h = (n - o.scrollTop) / r,
                    ...
                    u = setInterval((function() {
                        s += h, o.scrollTop = Math.round(s), ++i == r && (o.scrollTop = n, D(t, o), clearTimeout(u))
                    }), 10);
                return this
            }, HTMLCollection.prototype.scrollTo = NodeList.prototype.scrollTo = function(n, t, e) {
                return this.each((function(i) {
                    i.scrollTo(n, t, e)
                })), this
            }, HTMLElement.prototype.scroll = function(n, t, e) {
                return 0 == arguments.length ? this.scrollTop : this.scrollTo(this.scrollTop + n, t, e)
            }, HTMLCollection.prototype.scroll = NodeList.prototype.scroll = function(n, t, e) {
                return this.each((function(i) {
                    i.scroll(n, t, e)
                })), this
            }, HTMLElement.prototype.animate = function(n, t, e, i) {
                var o = JSON.stringify(n);
                (o.has("left") || o.has("top")) && ("static" == this.css("position") ? this.css({
                    position: "relative",
                    left: "0",
                    top: "0"
                }) : ("" == this.style.top && (this.style.top = this.css("top")), "" == this.style.left && (this.style.left = this.css("left")))), o.has("height") && "" == this.style.height && (this.style.height = this.css("height")), o.has("width") && "" == this.style.width && (this.style.width = this.css("width")), this.addClass("j-animation"), e = Q(this, e, i);
                var r = this;
                return setTimeout((function() {
                    r.css(n), setTimeout((function() {
                        D(t, r), r.removeClass("j-animation")
                    }), e)
                }), 50), this
            }, HTMLCollection.prototype.animate = NodeList.prototype.animate = function(n, t, e, i) {
                return this.each((function(o) {
                    o.animate(n, t, e, i)
                })), this
            }, HTMLElement.prototype.rotate = function(n, t, e, i, o) {
                var r = this;
                return r.addClass("j-animation"), setTimeout((function() {
                    e = Q(r, e, o), B(r, i), r.css({
            ...
            }, HTMLElement.prototype.scale = function(n, t, e, i) {
                return R(this, n, n, t, e, i)
            }, HTMLElement.prototype.scaleX = function(n, t, e, i) {
                return R(this, n, 1, t, e, i)
            }, HTMLElement.prototype.scaleY = function(n, t, e, i) {
                return R(this, 1, n, t, e, i)
            }, HTMLCollection.prototype.scale = NodeList.prototype.scale = function(n, t, e, i) {
                return this.each((function(o) {
                    o.scale(n, t, e, i)
                })), this
            }, HTMLCollection.prototype.scaleX = NodeList.prototype.scaleX = function(n, t, e, i) {
                return this.each((function(o) {
                    o.scaleX(n, t, e, i)
                })), this
            }, HTMLCollection.prototype.scaleY = NodeList.prototype.scaleY = function(n, t, e, i) {
                return this.each((function(o) {
                    o.scaleY(n, t, e, i)
                })), this
            }, HTMLCollection.prototype.rotate = NodeList.prototype.rotate = function(n, t, e, i, o) {
                return this.each((function(r) {
                    r.rotate(n, t, e, i, o)
                })), this
            }, HTMLElement.prototype.spin = function(n, t, e, i, o) {
                if (o = c(o, "linear"), t = c(t, "infinite"), n = null != n ? U(n) : 2, B(this, e), "number" == on.type(t)) {
                    this.stopSpin();
                    var r = this;
                    setTimeout((function() {
                        J(n, t, 0, i, o, r)
                    }), 20)
                } else J(n, t, 0, i, o, this);
                return this
            }, HTMLElement.prototype.twinkle = function(n, t, e, i) {
                if (i = c(i, "linear"), t = c(t, "infinite"), n = null != n ? U(n) : 2, "number" == on.type(t)) {
                    this.stopSpin();
                    var o = this;
                    setTimeout((function() {
                        F(n, t, e, i, o)
                ...
                return this
            }, HTMLCollection.prototype.twinkle = NodeList.prototype.twinkle = function(n, t, e, i) {
                return this.each((function(o) {
                    o.twinkle(n, t, e, i)
                })), this
            }, HTMLCollection.prototype.spin = NodeList.prototype.spin = function(n, t, e, i) {
                return this.each((function(o) {
                    o.spin(n, t, e, i)
                })), this
            }, HTMLElement.prototype.stopTwinkle = function(n) {
                var t = 1 == n ? "1" : this.css("opacity");
                return this.css({
                    animation: "none",
                    "-moz-animation": "none",
            ...
            }, HTMLElement.prototype.stopSpin = function(n) {
                var t = 1 == n ? "rotate(0)" : this.css("transform");
                return this.css({
                    animation: "none",
                    "-moz-animation": "none",
                    "-webkit-animation": "none",
            ...
            }, HTMLElement.prototype.tip = function(n) {
                return on.id("jetTip").exist() || on.body().append(on.ct("span#jetTip").clk('this.removeClass("j_active").css("top","-100px")')), "array" == on.type(n) && (n = n[0]), this.jetTip = n, this.on({
                    mousemove: function(n) {
                        on.id("jetTip").txt(this.jetTip).addClass("j_active").css({
                            top: n.pageY + 5 + "px",
                            left: n.pageX + 8 + "px"
                        })
                    },
                    mouseleave: function() {
                        on.id("jetTip").removeClass("j_active").css("top", "-100px")
                    }
                }, !0), this
            }, HTMLCollection.prototype.tip = NodeList.prototype.tip = function(n) {
                return "array" == on.type(n) ? this.each((function(t, e) {
                    t.tip(n[e])
                })) : this.each((function(t) {
                    t.tip(n)
                })), this
            }, HTMLElement.prototype.slideUp = function(n, t, e) {
                return Y(this) ? Z(this, n, t, e, !1) : this
            }, HTMLElement.prototype.slideDown = function(n, t, e) {
                return Y(this) ? this : (this.hasClass("j-fade") && this.removeClass("j-fade").addClass("j-slide"), Z(this, n, t, e, !0))
            }, HTMLElement.prototype.slideToggle = function(n, t, e) {
                return "none" != this.css("display") || this.hasClass("j-slide") || (this.addClass("j-for-slide-height"), this.css("height", this.hei() + "px"), this.removeClass("j-for-slide-height"), this.css("display", "block").addClass("j-slide").hide()), this.hasClass("j-fade") && this.removeClass("j-fade").addClass("j-slide"), Z(this, n, t, e)
            }, HTMLElement.prototype.fadeOut = function(n, t, e) {
                return Y(this) ? G(this, "j-fade", n, t, e, !1) : this
            }, HTMLElement.prototype.fadeIn = function(n, t, e) {
                return Y(this) ? this : (this.hasClass("j-slide") && this.removeClass("j-slide").addClass("j-fade"), G(this, "j-fade", n, t, e, !0))
            }, HTMLElement.prototype.fadeToggle = function(n, t, e) {
                return "none" != this.css("display") || this.hasClass("j-fade") || this.css("display", "initial").addClass("j-fade").hide(), this.hasClass("j-slide") && this.removeClass("j-slide").addClass("j-fade"), G(this, "j-fade", n, t, e)
            }, HTMLElement.prototype.hide = function() {
                return this.hasAttr("j-display") ? this : (this.attr("j-display", this.css("display")), this.css("display", "none!important"))
            }, HTMLElement.prototype.show = function(n) {
                return "none" == this.css("display") && this.css("display", "block!important"), this.hasAttr("j-display") ? (null == n && this.removeClass("j-fade j-slide"), this.css("display", this.attr("j-display") + "!important").removeAttr("j-display")) : this
            }, HTMLElement.prototype.showToggle = function() {
                this.hasAttr("j-display") ? this.show() : this.hide()
            }, HTMLCollection.prototype.slideUp = NodeList.prototype.slideUp = function(n, t, e) {
                return this.each((function(i) {
                    i.slideUp(n, t, e)
                })), this
            }, HTMLCollection.prototype.slideDown = NodeList.prototype.slideDown = function(n, t, e) {
                return this.each((function(i) {
                    i.slideDown(n, t, e)
                })), this
            }, HTMLCollection.prototype.slideToggle = NodeList.prototype.slideToggle = function(n, t, e) {
                return this.each((function(i) {
                    i.slideToggle(n, t, e)
                })), this
            }, HTMLCollection.prototype.fadeIn = NodeList.prototype.fadeIn = function(n, t, e) {
                return this.each((function(i) {
                    i.fadeIn(n, t, e)
                })), this
            }, HTMLCollection.prototype.fadeOut = NodeList.prototype.fadeOut = function(n, t, e) {
                return this.each((function(i) {
                    i.fadeOut(n, t, e)
                })), this
            }, HTMLCollection.prototype.fadeToggle = NodeList.prototype.fadeToggle = function(n, t, e) {
                return this.each((function(i) {
                    i.fadeToggle(n, t, e)
                })), this
            ...
            }, HTMLElement.prototype.scrollXTo = function(n, t, e) {
                var i = 0,
                    o = this,
                    r = y(e = c(e, 400)) / 10,
                    h = (n - o.scrollLeft) / r,
                    s = o.scrollLeft,
                    u = setInterval((function() {
                        s += h, o.scrollLeft = Math.round(s), ++i == r && (o.scrollLeft = n, D(t, o), clearTimeout(u))
                    }), 10);
                return this
            }, HTMLCollection.prototype.scrollXTo = NodeList.prototype.scrollXTo = function(n, t, e) {
                return this.each((function(i) {
                    i.scrollXTo(n, t, e)
                })), this
            }, HTMLElement.prototype.scrollX = function(n, t, e) {
                return 0 == arguments.length ? this.scrollLeft : this.scrollXTo(this.scrollLeft + n, t, e)
            }, HTMLCollection.prototype.scrollX = NodeList.prototype.scrollX = function(n, t, e) {
                return this.each((function(i) {
                    i.scrollX(n, t, e)
                })), this
                ...
                return null == n ? this.children : this.children[n]
            }, HTMLElement.prototype.hasChild = function(n) {
                return null == n ? this.children.length > 0 : 0 != this.select(n).length
            }, HTMLElement.prototype.clone = function() {
                return this.cloneNode().html(this.html())
            }, HTMLElement.prototype.parent = function(n) {
                if (null == n) return this.parentElement;
                for (var t = this, e = 0; e < n; e++) t = t.parentElement;
                return t
            }, HTMLElement.prototype.bro = function(n) {
                return null == n ? this.parent().child() : this.parent().child(n)
            }, HTMLElement.prototype.prepend = function(n) {
                var t = on.type(n);
                if ("array" == t || "htmlcollection" == t || "nodelist" == t) {
                    var e = this;
                    n.each((function(n) {
                        e.insertBefore(nn(n), e.children[0])
                    }))
                } else this.insertBefore(nn(n), this.children[0]);
                return this
            }, HTMLCollection.prototype.prepend = NodeList.prototype.prepend = function(n) {
                return this.each((function(t) {
                    t.prepend(n)
                })), this
            }, HTMLElement.prototype.append = function(n, t) {
                if (null == t) {
                    var e = on.type(n);
                    if ("array" == e || "htmlcollection" == e || "nodelist" == e)
                        for (var i = 0; i < n.length; i++) this.append(n[i]);
                    else "string" == e ? this.append(nn(n)) : this.appendChild(nn(n))
                } else this.insertBefore(nn(n), this.children[t]);
                return this
            }, HTMLElement.prototype.toArray = function() {
                return [this]
            }, HTMLCollection.prototype.toArray = NodeList.prototype.toArray = function() {
                for (var n = [], t = 0; t < this.length; t++) n.push(this[t]);
                return n
            }, HTMLElement.prototype.after = function(n) {
                var t = on.type(n);
                if ("array" == t || "htmlcollection" == t || "nodelist" == t) {
                    var e = this,
                        i = e.next();
                    n.each((function(n) {
                        e.parent().insertBefore(nn(n), i)
                    }))
                } else this.parent().insertBefore(nn(n), this.next());
                return this
            }, HTMLCollection.prototype.after = NodeList.prototype.after = function(n) {
                return this.each((function(t) {
                    t.after(n)
                })), this
            }, HTMLElement.prototype.before = function(n) {
                var t = on.type(n);
                if ("array" == t || "htmlcollection" == t || "nodelist" == t) {
                    var e = this;
                    n.each((function(n) {
                        e.parent().insertBefore(nn(n), e)
                    }))
                } else this.parent().insertBefore(nn(n), this);
                return this
            }, HTMLCollection.prototype.before = NodeList.prototype.before = function(n) {
                return this.each((function(t) {
                    t.before(n)
                })), this
            }, HTMLCollection.prototype.append = NodeList.prototype.append = function(n, t) {
                return this.each((function(e) {
                    e.append(n, t)
                })), this
            }, HTMLElement.prototype.index = function() {
                for (var n = this.parent().child(), t = 0; t < n.length; t++)
                    if (n[t] == this) return t;
                return -1
            }, HTMLElement.prototype.on = function(n, t, e) {
                if ("string" == on.type(n)) return this.event("on" + n, t, e);
                for (var i in n) n["on" + i] = n[i], delete n[i];
                return this.event(n, t)
            }, HTMLCollection.prototype.on = NodeList.prototype.on = function(n, t, e) {
                return this.each((function(i) {
                    i.on(on.clone(n), t, e)
                })), this
            }, HTMLElement.prototype.clk = function(n, t) {
                return this.event("onclick", n, t)
            }, HTMLCollection.prototype.clk = NodeList.prototype.clk = function(n, t) {
                return this.each((function(e) {
                    e.clk(n, t)
                })), this
            }, HTMLElement.prototype.event = function(n, t, e) {
                if ("string" == on.type(n)) 1 == e ? tn(this, n, t) : this[n] = o(t);
                else
                    for (var i in n) null != n[i] && (1 == t ? tn(this, i, n[i]) : this[i] = o(n[i]));
                return this
            }, HTMLCollection.prototype.event = NodeList.prototype.event = function(n, t, e) {
                return this.each((function(i) {
                    i.event(n, t, e)
                })), this
            ...
            }, HTMLCollection.prototype.remove = NodeList.prototype.remove = function(n) {
                if (null == n)
                    for (; 0 < this.length;) this[0].remove();
                else if ("number" == on.type(n)) {
                    for (var t = 0; t < this.length; t++)
                        if (t == n) return this[t].remove(), this
                } else
                    for (var e = 0; e < this.length; e++)
                        if (this[e] == n) return this[e].remove(), this
            }, HTMLElement.prototype.each = function(n, t) {
                return n(this, 0, t), this
            }, HTMLCollection.prototype.each = NodeList.prototype.each = function(n, t) {
                for (var e = this.toArray(), i = 0; i < e.length; i++) n(e[i], i, t);
                return this
                ...
                return this[0]
            }, HTMLElement.prototype.exist = function(n) {
                return null != n && o(n)(this), !0
            }, HTMLCollection.prototype.exist = NodeList.prototype.exist = function(n, t) {
                return this.length > 0 ? (1 == this.length ? o(n)(this[0]) : o(n)(this), !0) : (o(t)(), !1)
            }, HTMLElement.prototype.addValid = function(n) {
                if (this.hasAttr("jet-form"))
                    if ("json" == on.type(n) || "object" == on.type(n))
                        for (var t in n) this.findAttr("jet-name=" + t).addValid(n[t]);
                    else this.findAttr("jet-name").addValid(n);
                else this.attr({
                    "jet-valid": n
                }), 1 != this._jet_v_event && (this.on({
                    blur: "J.validInput(this)",
                    focus: "J.addValidValue(this)"
                }, !0)._jet_v_event = !0);
                return this
            }, HTMLCollection.prototype.addValid = NodeList.prototype.addValid = function(n) {
                return "array" == on.type(n) ? this.each((function(t, e) {
                    t.addValid(n[e])
                })) : this.each((function(t) {
                    t.addValid(n)
                ...
                return this.hasAttr("jet-form") ? this.findAttr("jet-name").clearValid() : (this.hasClass("jet-unpass") && this.removeClass("jet-unpass").val(this.attr("jet-value")), this.removeAttr("jet-valid jet-value")), this
            }, HTMLCollection.prototype.clearValid = NodeList.prototype.clearValid = function() {
                return this.each((function(n) {
                    n.clearValid()
                })), this
            }, HTMLElement.prototype.resetValid = function() {
                return this.hasAttr("jet-form") ? this.findAttr("jet-name").resetValid() : this.hasClass("jet-unpass") && this.removeClass("jet-unpass").val(this.attr("jet-value")), this
                ...
                return C(this)
            }, HTMLElement.prototype.get = function(n, t) {
                return on.get(this, n, t)
            }, HTMLElement.prototype.initValid = function() {
                return on.initValid(this), this
            }, HTMLCollection.prototype.initValid = NodeList.prototype.initValid = function() {
                return this.each((function(n) {
                    n.initValid()
                })), this
            }, HTMLElement.prototype.set = function(n, t, e) {
                return on.set(this, n, t, e), this
            }, HTMLElement.prototype.clear = function(n) {
                return on.clear(this, n), this
            }, HTMLElement.prototype.validate = function(n, t) {
                L(this, n, t)
            }, String.prototype.reverse = function() {
                for (var n = "", t = this.length - 1; t >= 0; t--) n += this[t];
                return n
            }, String.prototype.has = function(n) {
                return "string" == on.type(n) ? null == this.includes ? -1 != this.indexOf(n) : this.includes(n) : null != this.match(n)
            }, String.prototype.timeOf = function(n) {
                if ("string" == on.type(n)) return this.split(n).length - 1;
                var t = this.match(n);
                ...
                if ("array" == on.type(t)) {
                    ...
                    var o = "",
                        r = this,
                        h = this.match(n);
                    return null != h ? (h.each((function(n, e) {
                        o += r.substring(0, r.indexOf(n)) + t[e], r = r.substring(r.indexOf(n) + n.length)
                    })), o += r) : this
                }
                return "string" == on.type(n) ? this.replace(new RegExp(n, "g"), t) : this.replace(n, t)
            }, String.prototype.indexsOf = function(n, t) {
                var e = this.split(n),
                    i = null;
                if ("string" != on.type(n) && (i = this.match(n)), e.length <= 2) return -1 == this.indexOf(n) ? [] : [this.indexOf(n)];
                var o = [],
                    r = 0;
                return e.each((function(t, e) {
                    e > 0 && (o[o.length] = r, r += null != i ? i[e - 1].length : n.length), r += t.length
                })), null == t ? o : t > o.length - 1 ? o[o.length - 1] : o[t]
            }, String.prototype.insert = function(n, t) {
                return this.substring(0, t) + n + this.substring(t)
            };
            var en = {
                ready: h,
                onload: function(n) {
                ...
                id: function(n) {
                    return p(document.getElementById(n))
                },
                tag: function(n) {
                    return p(document.getElementsByTagName(n))
                },
                attr: function(n) {
                    return p(document.querySelectorAll("[" + n + "]"))
                },
                name: function(n) {
                    return p(document.getElementsByName(n))
                },
                select: function(n) {
                    return p(document.querySelectorAll(n))
                },
                ...
                each: function(n, t, e) {
                    ...
                    if ("json" == i || "object" == i) {
                        var o = 0;
                        for (var r in n) "function" != on.type(n[r]) && t(n[r], r, o, n), o++
                    } else "number" == i || "boolean" == i || "string" == i || "function" == i ? t(n, 0, e) : n.each(t, e);
                    return n
                },
                even: g,
                toString: function n(t) {
                    ...
                    var e = on.type(t);
                    if ("json" == e || "object" == e) return JSON.stringify(t);
                    if ("string" == e) return '"' + t + '"';
                    if ("array" == e) {
                        for (var i = "[", o = 0; o < t.length; o++) i += n(t[o]) + ",", o == t.length - 1 && (i = i.substring(0, i.length - 1));
                        return i + "]"
                    }
                    if ("htmlelement" == e || "htmlcollection" == e || "nodelist" == e) {
                        var r = t.allHtml();
                        return "array" == on.type(r) ? r.toString() : r
                    }
                    return t.toString()
                },
                type: function(n) {
                    if (0 == arguments.length) throw new Error("This function need a argument");
                    var t = i(n);
                    if ("object" == t) {
                        if (null === n) return "null";
                        var e = n.constructor;
                        switch (e) {
                            ...
                            case Date:
                                ...
                                break;
                            default:
                                t = 1 === n.nodeType && "string" == typeof n.nodeName ? "htmlelement" : "object"
                        }
                    }
                    return t
                },
                ct: function(n) {
                    if (n.has("#") || n.has(".") || n.has("[")) {
                        var t, e = n.split("#");
                        if (e.length > 1 && (e = [e[0], n.substring(e[0].length + 1)]), n.has("[")) {
                            var i = e[e.length - 1];
                            (t = i.substring(0, i.indexOf("[")).split("."))[t.length - 1] += i.substring(i.indexOf("["))
                        } else t = e[e.length - 1].split(".");
                        for (var o = t.length - 1, r = t[o].split("["), h = 0; h < r.length; h++) t[o + h] = r[h];
                        var s, u = r.length - 1,
                            a = t.length - u - 1;
                        1 == e.length ? s = document.createElement(t[0]) : (s = document.createElement(e[0])).attr("id", t[0]);
                        for (var l = 1; l < t.length; l++)
                            if (a > 0) a--, s.addClass(t[l]);
                            else {
                                var g = t[l].substring(0, t[l].length - 1),
                                    c = g.indexOf("=");
                                s.attr(g.substring(0, c), g.substring(c + 1))
                            } return s
                    }
                    return document.createElement(n)
                },
                scroll: function(n, t, e) {
                    if (0 == arguments.length) return 0 == document.body.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop;
                    0 != n && (document.body.scroll(n, null, e), document.documentElement.scroll(n, null, e), null != t && (e = c(e, 400), "number" == on.type(e) && (e = y(e)), setTimeout(o(t), e)))
                },
                scrollTo: function(n, t, e) {
                    document.body.scrollTo(n, null, e), document.documentElement.scrollTo(n, null, e), null != t && (e = c(e, 400), "number" == on.type(e) && (e = y(e)), setTimeout(o(t), e))
                },
                ajax: function(n) {
                    var t, e = {
                        type: n.type || "get",
                        ...
                        async: n.async || !0,
                        data: n.data || null,
                        dataType: n.dataType || "text",
                        contentType: n.contentType || "application/x-www-form-urlencoded",
                        beforeSend: n.beforeSend || function() {},
                        success: n.success || function() {},
                        error: n.error || function() {},
                        header: n.header || {}
                    };
                    e.beforeSend(), window.XMLHttpRequest ? t = new XMLHttpRequest : window.ActiveXObject && (t = window.ActiveXObject("Microsoft.XMLHTTP"));
                    var o = function(n) {
                            if (null == n) return "";
                            var t = on.type(n);
                            if ("json" == t) {
                                var e = "";
                                for (var o in n) "object" === i(n[o]) ? e += o + "=" + encodeURIComponent(JSON.stringify(n[o])) + "&" : e += o + "=" + encodeURIComponent(n[o]) + "&";
                                return e.substring(0, e.length - 1)
                            }
                            return "array" == t ? JSON.stringify(n) : (on.type(n), n)
                        }(e.data),
                        r = e.type.toLowerCase();
                    for (var h in "get" == r && "" !== o && (e.url = e.url + "?" + o), t.open(e.type, e.url, e.async), t.responseType = e.dataType, null !== n.contentType && t.setRequestHeader("Content-Type", e.contentType), e.header) t.setRequestHeader(h, e.header[h]);
                    return "get" == e.type.toLowerCase() ? t.send() : t.send(o), t.onreadystatechange = function() {
                        4 == t.readyState && (200 == t.status ? e.success(t.response || t.responseText) : e.error(t.response || t.responseText))
                    }, t
                },
                load: function(n, t, e) {
                    on.ajax({
                        ...
                        error: function(n) {
                            throw null != e && e(n), new Error("加载失败")
                        }
                    })
                },
                jsonp: function(n) {
                    if (!n.url) throw new Error("Parameter error");
                    var t = ("_jsonp" + Math.random()).replace(".", "").substring(0, 15),
                        e = on.tag("head");
                    n.data[c(n.callback, "callback")] = t;
                    var i = on.ct("script");
                    e.append(i), window[t] = function(o) {
                        e.removeChild(i), clearTimeout(i.timer), window[t] = null, "string" == on.type(o) && (o = JSON.parse(o)), n.success && n.success(o)
                    }, null != n.dataType && "JSON" == n.dataType.toUpperCase() ? i.attr("src", n.url + "?json=" + encodeURIComponent(JSON.stringify(n.data))) : i.attr("src", n.url + "?" + function(n) {
                        var t = [];
                        for (var e in n) t.push(encodeURIComponent(e) + "=" + encodeURIComponent(n[e]));
                        return t.join("&")
                    }(n.data)), n.time = c(n.time, 5e3), i.timer = setTimeout((function() {
                        window[t] = null, e.removeChild(i), n.timeout && n.timeout({
                            message: n.message ? n.message : "timeout"
                        })
                    }), n.time)
                },
                cookie: function(n, t, e, i) {
                    if (1 == arguments.length) {
                        if (document.cookie.length > 0) {
                            ...
                            if (-1 != o) {
                                ...
                                return -1 == r && (r = document.cookie.length), unescape(document.cookie.substring(o, r))
                            }
                        }
                        return ""
                    }
                    if (null != t) {
                        ...
                        if (null != e) {
                            var s = new Date;
                            s.setDate(s.getDate() + e), h += ";expires=" + s.toGMTString()
                        }
                        return null != i && ("boolean" == on.type(i) ? i && (h += ";path=/") : h += ";path=" + i), document.cookie = h, n + "=" + t
                    }
                    on.cookie(n, "", -1)
                },
                storage: function n(t, e) {
                    if ("object" !== i(t) || null === t) {
                        ...
                        if (void 0 === e) {
                            ...
                            if (null === t) Object.keys(o).forEach((function(n) {
                                o.removeItem(n)
                            }));
                            else {
                                var h = o.getItem(t);
                                try {
                                    ...
                                    return h === parseFloat(h).toString() ? parseFloat(h) : h
                                }
                            }
                        } else {
                            if (null !== e) return "object" === i(e) ? o.setItem(t, JSON.stringify(e)) : o.setItem(t, e), e;
                            o.removeItem(t)
                        }
                    } else
                ...
                initTip: function() {
                    en.attr("jet-tip").each((function(n) {
                        n.tip(n.attr("jet-tip"))
                    }))
                },
                html5: function() {
                ...
                urlParam: function() {
                    var n = "";
                    if ("" != location.search ? n = location.search.substring(1) : location.hash.has("?") && (n = location.hash.substring(location.hash.indexOf("?") + 1)), "" == n) return null;
                    for (var t = decodeURI(n).split("&"), e = {}, i = 0; i < t.length; i++) {
                        var o = t[i].split("=");
                        e[o[0]] = o[1]
                    }
                    return e
                ...
                random: function(n, t) {
                    return n + Math.round(Math.random() * (t - n))
                },
                isMobile: function() {
                ...
                clearRepeat: function(n) {
                    return clearInterval(n)
                },
                jetForm: function(n) {
                    return en.attr("jet-form=" + n)
                },
                jetName: function(n, t) {
                    return 2 == arguments.length ? en.attr("jet-form=" + n).findAttr("jet-name=" + t) : en.attr("jet-name=" + n)
                },
                useDefaultStyle: !0,
                useShowForValid: !0,
                showInPlaceHolder: !1,
                noteStyleStr: "color",
                get: function(n, t, e) {
                    return e = this.checkArg(e, "jet-name"), null != t && "json" != t ? function(n, t) {
                        var e = n.select("[" + t + "]"),
                            i = new FormData;
                        return e.each((function(n) {
                            i.append(n.attr(t), q(n))
                        })), i
                    }(k(n), e) : function(n, t) {
                        var e = n.select("[" + t + "]"),
                            i = {};
                ...
                set: function(n, t, e, i) {
                    i = this.checkArg(i, "jet-name"),
                        function(n, t, e, i) {
                            n.select("[" + t + "]").each((function(n) {
                                var o = n.attr(t),
                                    r = "",
                                    h = "";
                                n.hasAttr("jet-set") && (r = n.attr("jet-set")).has(":") && (h = r.split(":")[1], r = r.split(":")[0]);
                                var s = function(n, t) {
                                    if ("json" == on.type(n) || "object" == on.type(n)) return n[t];
                                    if ("formdata" != on.type(n)) throw new Error("该方法不支持Object和FormData以外的数据类型");
                                    try {
                                        return n.get(t)
                                    } catch (n) {
                                ...
                                }(n, s, r, h), null != i && i(n, s, o)
                            }))
                        }(k(n), i, t, e)
                },
                clear: function(n, t) {
                    this.set(n, {}, null, t), n.select("select[jet-name]").each((function(n) {
                        n.child(0).selected = !0
                    }))
                },
                addValid: function(n, t) {
                    t = this.checkArg(t, "notnull"), k(n).addValid(t)
                },
                initValid: function(n) {
                    (null == n ? en.attr("jet-valid") : k(n).select("[jet-valid]")).each((function(n) {
                        n.on({
                            blur: "J.validInput(this)",
                            focus: "J.addValidValue(this)"
                        }, !0)._jet_v_event = !0, en.showInPlaceHolder && n.attr("placeholder", M(n.attr("jet-valid")))
                    }))
                },
                clearValid: function(n) {
                    k(n).clearValid()
                },
                resetValid: function(n) {
                    k(n).resetValid()
                },
                validate: function(n, t, e) {
                    null != e ? L(k(n), t, e) : L(k(n), t)
                },
                validText: function(n, t) {
                    if ("json" == en.type(n) && null == t)
                        for (var e in n) this.validText(e, n[e]);
                    else "CHINESE" == this.language ? S[n] = t : N[n] = t
                },
                banDefault: function() {
                    this.useDefaultStyle = !1, en.cls("jet-unpass").each((function(n) {
                        z(n), n.removeClass("jet-unpass").val(n.attr("jet-value")).removeAttr("jet-value")
                    }))
                },
                useDefault: function() {
                ...
                banValidShow: function() {
                    this.useShowForValid = !1
                },
                useValidShow: function() {
                    this.useShowForValid = !0
                },
                banPlaceHolder: function() {
                    this.showInPlaceHolder = !1, en.attr("jet-valid").each((function(n) {
                        n.attr("placeholder", "")
                    }))
                },
                usePlaceHolder: function() {
                    this.showInPlaceHolder = !0, en.attr("jet-valid").each((function(n) {
                        n.attr("placeholder", M(n.attr("jet-valid")))
                    }))
                },
                show: I,
                confirm: function(n, t, e) {
                    var i = on.id("jetConfirmContent");
                    i.exist() || (function() {
                        var n = on.ct("span").addClass("jet-icon-circle jet-no-border").append([on.ct("span").addClass("jet-icon-part-ok1 jet-rotate-45"), on.ct("span").addClass("jet-icon-part-ok2 jet-rotate-45")]),
                            t = on.ct("span").addClass("jet-icon-circle jet-no-border").append([on.ct("span").addClass("jet-icon-part-x jet-rotate-45"), on.ct("span").addClass("jet-icon-part-x jet-rotate-045")]),
                            e = on.ct("div").attr({
                                id: "jetConfirmOk",
                                onclick: "J.confirmOk()"
                            }).append(n),
                            ...
                            o = on.ct("div").attr("id", "jetConfirmBtnWrapper").append([e, i]),
                            r = on.ct("div").attr("id", "jetConfirmContent"),
                            h = on.ct("div").attr("id", "jetConfirmWrapper").append([r, o]);
                        on.body().append(h)
                    }(), i = on.id("jetConfirmContent")), i.txt(n), setTimeout((function() {
                        on.id("jetConfirmWrapper").css("top", "0")
                    }), 0), W = o(t), _ = o(e)
                },
                showWait: function(n, t) {
                    I(n, t = on.checkArg(t, "info"), 0, (function() {}), !1)
                },
                close: O,
                confirmClose: P,
                inputClose: v,
                noteStyle: function(n) {
                    null == n && (n = "gray");
                    var t = on.id("jetNoteWrapper"),
                        e = on.noteStyleStr;
                    on.noteStyleStr = n, null != t && ("simple" != e && "simple" == n ? t.empty() : "simple" != n && "simple" == e && (t.empty(), t.append(X())), t.attr("jet-style", n)), O()
                },
                validInput: T,
                addValidValue: function(n) {
                    n.hasClass("jet-unpass") && (n.content(n.attr("jet-value")), z(n))
                },
                onOnePass: function(n) {
                    b = o(n)
                },
                onOneFail: function(n) {
                    x = o(n)
                },
                confirmOk: function() {
                    if (null != W) {
                ...
                inputOk: function() {
                    null != m ? on.id("jetInputContent").validate((function() {
                        var n = m;
                        m = null, n(on.id("jetInputContent").findClass("jet-input").val()), v()
                    })) : on.id("jetInputContent").validate((function() {
                        v()
                    }))
                },
                ...
                input: function(n, t, e) {
                    var i = on.id("jetInputContent");
                    if (i.exist() || (function() {
                            var n = on.ct("span").addClass("jet-icon-circle jet-no-border").append([on.ct("span").addClass("jet-icon-part-ok1 jet-rotate-45"), on.ct("span").addClass("jet-icon-part-ok2 jet-rotate-45")]),
                                t = on.ct("span").addClass("jet-icon-circle jet-no-border").append([on.ct("span").addClass("jet-icon-part-x jet-rotate-45"), on.ct("span").addClass("jet-icon-part-x jet-rotate-045")]),
                                e = on.ct("div").attr({
        ...
        n.exports = function(n) {
            ...
            var i, o = {
                ...
                h = function(n) {
                    var t = o.info.initial;
                    n = n.toLowerCase();
                    var e = i.removeTone(n, !1);
                    if (-1 === e.index) {
                        if (!o.spell[e.spell]) throw new Error("【spellInfo】错误的拼音: " + n + ", 请检查字符是否正确");
                        e.index = parseInt(o.spell[e.spell][0]) + 1
                    }
                    for (var r = "", h = e.spell, s = 0; s < t.length; s++)
                        if (0 === e.spell.indexOf(t[s])) {
                            r = t[s], h = e.spell.substr(r.length);
                            break
                        } return {
                        spell: e.spell,
                        tone: e.tone,
                ...
                s = function() {
                    ...
                    var i = Array(n),
                        o = 0;
                    for (t = 0; t < e; t++)
                        for (var r = arguments[t], h = 0, s = r.length; h < s; h++, o++) i[o] = r[h];
                    return i
                };

            function u() {
                for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
                console.warn.apply(console, s(["CnChar Warning:"], n))
            }
            var a = function(n, t, e) {
                if ("object" != typeof n) e(n, t);
                else
                    for (var i in n) e(i, n[i])
            };

            function l(n, t) {
                if (void 0 === t && (t = 1), !n || 0 === n.length || 0 === t) return [];
                if (t >= n.length) return g(Object.assign([], n));
                for (var e = [], i = n.length, o = []; o.length < t;) {
                    var r = c(0, i - 1);
                    o.includes(r) || (o.push(r), e.push(n[r]))
                }
                return e
            }

            function g(n) {
                for (var t, e, i = n.length; i;) e = Math.floor(Math.random() * i--), t = n[i], n[i] = n[e], n[e] = t;
                return n
            }
            ...
            var p, d = function(n) {
                    var t;
                    return 1 === n.length ? !!n.match(/[\u4e00-\u9fa5]/) : (null === (t = n.match(/[\u4e00-\u9fa5]/g)) || void 0 === t ? void 0 : t.join("").length) === n.length
                },
                f = function(n, t) {
                    return -1 !== n.indexOf(t)
                },
                y = "āáǎàōóǒòēéěèīíǐìūúǔùǖǘǚǜ*ńňǹ",
                m = {
                    array: "array",
                    low: "low",
                    up: "up",
            ...
            function b(n, t) {
                ...
                var r = f(i, m.poly),
                    ...
                    s = [];
                for (var u in n)
                    for (var a = n[u], l = parseInt(a[0]), g = function(n) {
                            var t = e[n],
                                i = function(e) {
                                    T(t, e) ? s[n].unshift(e) : s[n].push(e)
                                };
                            if (d(t)) {
                                var g = a.indexOf(t);
                                if (-1 !== g) {
                                    ...
                                    if (c.poly) {
                                        s[n] || (s[n] = []), i(c.res);
                                        for (var p = a, f = p.match(new RegExp(t, "g")).length, y = 1; y < f; y++) g = (p = p.substr(g + 2)).indexOf(t), i(C(u, p, g, r, h, l).res)
                                    } else c.isPolyWord && o.spellDefault[t] && (c.res = L(o.spellDefault[t], h).spell), s[n] = [c.res], e[n] = ""
                                }
                            } else "" !== t && (s[n] = ["NOT_CNCHAR", t])
                        }, c = 0; c < e.length; c++) g(c);
                x(s, i);
                var p = [];
                for (c = 0; c < e.length; c++) {
                    var y = s[c];
                    void 0 === y ? p[c] = e[c] : y.length > 1 ? "NOT_CNCHAR" === y[0] ? p[c] = y[1] : p[c] = "(" + y.join("|") + ")" : p[c] = y[0], f(i, m.flat) && f(i, m.tone) && (p[c] = I(p[c], !0))
                }
                return f(i, m.array) ? p : p.join("")
            }
            var x = function(n, t) {
                p._.poly && z(n, q), f(t, m.first) && z(n, v), f(t, m.up) ? z(n, w) : f(t, m.low) || z(n, k)
            };

            function z(n, t) {
                n.forEach((function(e, i) {
                    "string" != typeof e ? "NOT_CNCHAR" !== e[0] && e.forEach((function(n, i) {
                        e[i] = t(n)
                    })) : n[i] = t(e)
                }))
            }
            ...
            function C(n, t, e, i, o, r) {
                var h = parseInt(t[e + 1]),
                    s = {
                        res: n,
                        poly: !1,
                        isPolyWord: h >= 5
                    };
                return i || o ? (s.isPolyWord && (h -= 5, i && (s.poly = !0)), o && (s.res = S(n, r, h)), s) : s
            }

            function T(n, t) {
                var e = o.spellDefault[n];
                return !!e && (e === t || I(e, !0).replace(/[0-4]/, "") === t)
            }
            var L = function(n, t) {
                if (t) return {
                    spell: n
                ...
                for (var e = 0; e < n.length; e++) {
                    var i = y.indexOf(n[e]);
                    if (-1 !== i) return {
                        spell: n.substr(0, e) + "aoeiuün" [Math.floor(i / 4)] + n.substr(e + 1),
                        tone: i % 4 + 1,
                        index: e + 1
                    }
                }
            ...
            function S(n, t, e) {
                if (0 === e) return n;
                var i = n[t],
                    o = y[4 * "aoeiuün".indexOf(i) + (e - 1)];
                return i !== o ? n.replace(i, o) : n
            }
            ...
            function N(n, t) {
                var e = t[0].split(""),
                    i = [],
                    o = t.splice(1);
                for (var r in H("stroke", o), n)
                    for (var h = 0; h < e.length; h++) e[h] && -1 !== n[r].indexOf(e[h]) && (e[h] = "", i[h] = parseInt(r));
                    ...
                    if (p.check)
                        if (E) E = !1;
                            ...
                            for (var i = [], o = t.length - 1; o >= 0; o--) {
                                var r = t[o];
                                p.type[n][r] || (i.push(r), t.splice(o, 1))
                            }
                            var h = [],
                                s = [],
                                u = function(n, e) {
                                    void 0 === e && (e = h), n instanceof Array ? n.forEach((function(n) {
                                        u(n, e)
                                    })) : f(t, n) && e.push(n)
            ...
            function A(n, t, e, i) {
                if (n.length > 0) {
                    var o = "以下参数" + t + ":" + JSON.stringify(n) + ";";
                    "被忽略" !== t || "stroke" !== e || f(i, "order") ? o += " 可选值：[" + Object.keys(p.type[e]) + "]" : o += " 要启用笔顺模式必须使用 order 参数", u(o)
                }
            }

            function I(n, t) {
                void 0 === t && (t = !1);
                var e = -1 !== "01234".indexOf(n[n.length - 1]);
                if (!t) return e ? O(n, !0, "low").spell : n;
                if (e) return n;
                var i = O(n, !1, "low");
                return -1 !== i.spell.indexOf("ü") && (i.spell = i.spell.replace("ü", "v")), e ? n : i.spell + i.tone
            }
            var O = function(n, t, e) {
                    void 0 === t && (t = !1), void 0 === e && (e = "low"), -1 !== n.indexOf("v") && (n = n.replace("v", "ü"));
                    var i, o, r = n[n.length - 1],
                        s = -1,
                        u = !1;
                    return parseInt(r).toString() === r ? (n = n.substr(0, n.length - 1), s = (o = h(n)).index, i = parseInt(r), u = !0, t && (n = S(n, s - 1, i))) : (s = (o = h(n)).index, i = o.tone, t || 0 === i || (n = o.spell)), "low" === e ? n = n.toLowerCase() : "up" === e && (n = n.toUpperCase()), {
                        spell: n,
                        tone: i,
                        index: s,
                        isTrans: u
            ...
            function _(n, t, e, i, r) {
                if (void 0 === r && (r = !1), "object" != typeof e)
                    if (i instanceof Array) i.forEach((function(i) {
                        _(n, t, e, i, !0)
                    }));
                    else {
                        var h = O(i),
                        ...
                        if ((t = t).length >= 1) {
                            for (var u = 0; u < t.length; u++) {
                                var a = t[u];
                                if (a.spell === h.spell && a.tone === h.tone) return
                            }
                            r || (r = !0)
                        }
                        var l = "" + e + (h.tone + (r ? 5 : 0));
                        if (n[h.spell] = s ? s + l : h.index + ":" + l, 1 === t.length) {
                            var g = t[0];
                            n[g.spell] = n[g.spell].replace("" + e + g.tone, "" + e + (g.tone + 5))
                        }
                        r && function(n) {
                            -1 === o.info.polyWord.indexOf(n) && (o.info.polyWord += n)
                        }(e)
                    }
                else
                    for (var c in e) _(n, t[c], c, e[c])
            }

            function P(n, t) {
                var e = b(n, [t, m.tone, m.poly]);
                return e === t ? [] : (-1 !== e.indexOf("|") ? e.substring(1, e.length - 1).split("|") : [e]).map((function(n) {
                    return O(n)
                }))
            }
            var X, V, D = {
            ...
            function R(n) {
                ...
                if ("number" != typeof n || n <= 0) throw new Error("strokeToWord: 输入必须是正整数");
                X.checkArgs("strokeToWord", t);
                var i = "",
                    r = {
                        simple: X.has(t, D.simple),
                        trad: X.has(t, D.trad)
                    };
                return r.simple || r.trad || (r.simple = r.trad = !0), r.simple && (i += B(n, o.stroke)), r.trad && X.dict.getTradCount && (i += B(n, X.dict.getTradCount())), X.has(t, D.array) ? i.split("") : i
            }
            ...
            function F(n, t) {
                if (void 0 === t && (t = !1), !t) return n.charCodeAt(0);
                var e = function(n) {
                    var t = V._.tones.indexOf(n);
                    return -1 === t ? -1 : J[t]
                }(n);
                return -1 === e ? n.charCodeAt(0) : e
            }
            var U, $ = "tone",
                Y = "desc",
                Z = "more",
            ...
            function K(n, t) {
                var e = ["low"];
                if (t && e.push("tone"), U.isCnChar(n)) return U.spell.apply(U, function() {
                    for (var n = 0, t = 0, e = arguments.length; t < e; t++) n += arguments[t].length;
                    var i = Array(n),
                        o = 0;
                    for (t = 0; t < e; t++)
                ...
                try {
                    return U._.transformTone(n, t).spell
                } catch (n) {
                    return console.warn(n.message), ""
                }
            }

            function Q(n, t, e) {
                if (void 0 === e && (e = !1), !(n = K(n, e))) return Z;
                if (!(t = K(t, e))) return G;
                ...
                return n.length === t.length ? "even" : G
            }

            function nn(n, t) {
                return "string" == typeof n && (n = U.stroke(n)), "string" == typeof t && (t = U.stroke(t)), n > t ? Z : n < t ? G : "even"
            }
            var tn = function(n) {
                    var t = function() {
                        u("请先调用 cnchar-" + n)
                    };
                    return t.__default = !0, t
                },
                en = [];

            function on(n) {
                return -1 === en.indexOf(n) && (en.push(n), !0)
            }
            var rn = "",
                hn = "object" == typeof wx && "object" == typeof __wxConfig ? "miniapp" : "object" == typeof window ? "web" : "node",
                sn = function() {
            ...
            var gn, cn, pn, dn, fn, yn = sn(sn({
                ...
                use: function() {
                    ...
                    n.forEach((function(n) {
                        ...
                        if (t) {
                            if (on(t)) {
                                var r = e;
                                o && (r.type[t] = o), n.getCnChar = function() {
                                    return e
                                }, n.installed = !0, r[t] = n, i && i(e)
                            }
                        } else u("plugin name is required", n)
                    }))
                },
                _: {
                    arg: m,
                    has: f,
                    _throw: function(n) {
                        throw new Error("CnChar Error:" + n)
                    },
                    tones: y,
                    setIntoJson: W,
                    _warn: u,
                    ...
                    dict: {},
                    mapJson: a,
                    checkTrad: function(n, t) {
                        if (-1 === t.indexOf("trad") || -1 === p.plugins.indexOf("trad")) return n;
                        var e = !1;
                        return n instanceof Array && (e = !0, n = n.join("")), n = p.convert.tradToSimple(n), e ? n.split("") : n
                    },
                    ...
                    shuffle: g,
                    randomNum: c,
                    pickRandomChar: function(n, t) {
                        return void 0 === t && (t = 1), n ? l(n.split(""), t).join("") : ""
                    }
                },
                type: {
                    spell: m,
                ...
                compareSpell: Q,
                compareStroke: nn,
                sortSpell: function(n) {
                    for (var t = [], e = 1; e < arguments.length; e++) t[e - 1] = arguments[e];
                    var i = !1;
                    "string" == typeof n && (n = n.split(""), i = !0);
                    var o = -1 !== t.indexOf($),
                        r = -1 !== t.indexOf(Y),
                        h = r ? -1 : 1,
                        s = -1 * h,
                        u = n.sort((function(n, t) {
                            var e = Q(n, t, o);
                            return e === Z ? h : e === G ? s : 0
                        }));
                    return i ? u.join("") : u
                },
                sortStroke: function(n, t) {
                    var e = !1;
                    "string" == typeof n && (n = n.split(""), e = !0);
                    var i = t === Y ? -1 : 1,
                        o = -1 * i,
                        r = n.sort((function(n, t) {
                            var e = nn(n, t);
                            return e === Z ? i : e === G ? o : 0
                        }));
                    return e ? r.join("") : r
                },
                setSpellDefault: function(n, t) {
                    W({
                        target: o.spellDefault,
                        key: n,
                        value: t,
                        isSpell: !0
                    })
                },
                setSpell: function(n, t) {
                    ! function(n, t, e) {
                        var i;
                        if ("object" == typeof t)
                            for (var o in i = {}, t) i[o] = P(n, o);
                        else i = P(n, t);
                        _(n, i, t, e)
                    }(o.spell, n, t)
                },
                ...
                isPolyWord: function(n) {
                    return "" !== n && (n.length > 1 && (n = n[0]), !!d(n) && -1 !== o.info.polyWord.indexOf(n))
                },
                shapeSpell: I,
                hasTone: function(n) {
                    return !n.trim().match(/^[a-zA-Z]*$/)
                },
                spellToWord: function() {
                    for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
                    var e = n[0].toLowerCase();
                    if ("string" != typeof e) throw new Error("spellToWord: 输入必须是字符串");
                    var h = i.transformTone(e, !1),
                        s = n.splice(1);
                    i.checkArgs("spellToWord", s);
                    var u = {
                        simple: i.has(s, r.simple),
                        trad: i.has(s, r.trad),
                        poly: i.has(s, r.poly),
                        alltone: i.has(s, r.alltone)
                    };
                    u.simple || u.trad || (u.simple = u.trad = !0);
                    for (var a = "", l = o.spell[h.spell].substr(2), g = 0; g < l.length; g += 2) {
                        var c = l[g],
                            p = parseInt(l[g + 1]),
                            d = p > 4;
                        d && (p -= 5), -1 !== a.indexOf(c) || !u.alltone && p !== h.tone || u.poly && !d || (a += c)
                    }
                    if (u.trad && i.convert) {
                        var f = "";
                        for (g = 0; g < a.length; g++) {
                            var y = i.convert.simpleToTrad(a[g]);
                            y !== a[g] && (f += y)
                        }
                        u.simple ? a += f : a = f
                    }
                    return i.has(s, r.array) ? a.split("") : a
                },
                strokeToWord: R,
                spellInfo: h,
                setResourceBase: function(n) {
                    var t = this;
                    rn = n, this.plugins.forEach((function(n) {
                        var e, i = t[n];
                        i && (null === (e = i._refreshResource) || void 0 === e || e.call(i, t))
                    }))
                }
            }, (gn = tn("draw"), cn = tn("idiom"), pn = tn("radical"), dn = tn("xhy"), "object" == typeof window && (window.CncharIdiom = cn, window.CncharDraw = gn, window.CncharRadical = pn, window.CncharXHY = dn), {
                idiom: cn,
                draw: gn,
                setOrder: tn("order"),
                orderToWord: tn("order"),
                setPolyPhrase: tn("poly"),
                radical: pn,
                convert: {
                    type: {
                        trad: "trad",
            ...
            String.prototype.spell = function() {
                    for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
                    return an.apply(void 0, un([this], n))
                }, String.prototype.stroke = function() {
                    for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
                    return ln.apply(void 0, un([this], n))
                }, p = yn, i = (fn = yn)._, h.tones = i.tones.split(""), h.initials = o.info.initial, fn.spellInfo = h, fn.type.spellToWord = r,
                function(n) {
                    n.strokeToWord = R, n.type.strokeToWord = D, X = n._
                }(yn),
                function(n) {
                    U = n,
                        function(n) {
                            V = n, "aoeiuvn".split("").forEach((function(n) {
                                for (var t = n.charCodeAt(0), e = 1; e <= 4; e++) J.push(t + .1 * e)
                            }))
                        }(n)
                }(yn), "undefined" != typeof window && (window.cnchar = window.CnChar = yn), t.default = yn
        }]).default
    }, function(n, t, e) {
        n.exports = function(n) {
            var t = {};
            ...
            function l(n) {
                for (var t = [], e = 1; e < arguments.length; e++) t[e - 1] = arguments[e];
                if (o.checkArgs("spell", t, !0), o.has(t, o.arg.poly)) return r.apply(void 0, s([n], t));
                var i = [o.arg.array];
                t.forEach((function(n) {
                    "first" !== n && "up" !== n && "low" !== n && i.push(n)
                }));
                var h = o.has(t, o.arg.tone),
                    a = r.apply(void 0, s([n], i));
                for (var l in u) {
                    var g = n.indexOf(l);
                    if (-1 !== g)
                        for (var c = u[l].split(" "), p = 0; p < c.length; p++) a[g + p] = o.removeTone(c[p], h).spell
                }
                return o.dealUpLowFirst(a, t), o.has(t, o.arg.array) ? a : a.join("")
            }
            var g = function(n, t) {
                    if ("object" != typeof n) "string" == typeof t && (u[n] = t.split(" ").map((function(n) {
                        return i.shapeSpell(n)
                    })).join(" "));
                    else
                        for (var e in n) g(e, n[e])
                },
                c = {
                    pluginName: "poly",
                    install: function(n) {
                        n.setPolyPhrase = g, r = n._origin.spell, o = n._, i = n;
                        var t = function(n) {
                            for (var t = [], e = 1; e < arguments.length; e++) t[e - 1] = arguments[e];
                            return o.has(t, a) ? r.apply(void 0, s([n], t)) : l.apply(void 0, s([n], t))
                        };
                        n.spell = t, String.prototype.spell = function() {
                            for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
                            return t.apply(void 0, s([this], n))
                        }, n._.poly = !0, n._._reinitSpellPoly && (n._._reinitSpellPoly(), delete n._._reinitSpellPoly)
                    },
                    setPolyPhrase: g,
                    dict: {
                        phrases: u
            ...
            "object" == typeof window && window.CnChar && (window.CncharPoly = c, window.CnChar.use(c)), t.default = c
        }]).default
    }, function(n, t, e) {
        "use strict";
        e.r(t);
        var i, o, r, h, s, u, a = e(0),
            l = e.n(a),
            g = {
                gameWidth: 0,
                gameHeight: 0
        ...
        function m(n, t, e) {
            1 == t ? (e = l.a.checkArg(e, 2e3), l.a.id("showInfo").txt(n).fadeIn((function() {
                clearTimeout(y), y = setTimeout((function() {
                    j()
                }), e)
            }))) : l.a.id("showInfo").txt(n).fadeIn()
        }

        function j() {
            l.a.id("showInfo").fadeOut(null, 200)
        }
        ...
        function x(n, t) {
            for (var e = 0; e < t.length; e++) {
                var i = t[e];
                i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(n, (o = i.key, r = void 0, r = function(n, t) {
                ...
                }(o, "string"), "symbol" === b(r) ? r : String(r)), i)
            }
            var o, r
        }
        var z = 15;
        var v = function() {
            function n(t) {
                ...
                }(this, n), this.speed = z, this.w = 110, this.h = 110, this.x = c.player.x, this.y = c.player.y - c.player.h / 2 + this.h / 2, this.letter = t, this.deg = 0, this.target = this.findTarget(), this.img = h, this.dieImg = f(), this.isDie = !1, this.dieIndex = -1, this.dieLen = 50, this.isRemove = !1
            }
            var t, e, i;
            return t = n, (e = [{
                key: "act",
                value: function() {
                    this.isRemove || (null != this.target ? (this.isDie ? (this.dieIndex++, this.dieIndex >= this.dieImg.length && (this.dieIndex--, this.remove())) : (this.x += this.speed * Math.sin(this.deg), this.y -= this.speed * Math.cos(this.deg), this.touchTarget() && (this.target.hurt(), this.die())), this.draw()) : c.bullets.remove(this))
                }
            }, {
                key: "draw",
                value: function() {
                    if (c.ctx.save(), this.isDie) {
                        var n = this.target.x - Math.sin(this.target.deg) * this.target.h / 2,
                            t = this.target.y + Math.cos(this.target.deg) * this.target.h / 2;
                        c.ctx.translate(n, t), c.ctx.rotate(this.deg), c.ctx.translate(-n, -t), c.ctx.drawImage(this.dieImg[this.dieIndex], n - this.dieLen / 2, t - this.dieLen / 2, this.dieLen, this.dieLen)
                    } else c.ctx.translate(this.x, this.y), c.ctx.rotate(this.deg), c.ctx.translate(-this.x, -this.y), c.ctx.drawImage(this.img, this.x - this.w / 2, this.y - this.h / 2, this.w, this.h);
                    c.ctx.restore()
                }
            }, {
                key: "findTarget",
                value: function() {
                    if (null != c.player.target && c.player.target.check(this.letter)) return this.init(c.player.target), c.player.target;
                    for (var n = 0; n < c.enemys.length; n++)
                        if (c.enemys[n].check(this.letter)) return this.init(c.enemys[n]), c.enemys[n];
                    return c.player.setErr(), m("没有找到目标", !0, 1e3), null
                }
            }, {
                key: "touchTarget",
                value: function() {
                ...
                key: "die",
                value: function() {
                    this.dieIndex = 0, this.isDie = !0
                }
            }, {
                key: "remove",
                value: function() {
                    this.isRemove = !0, c.player.setLetterNum(), c.bullets.remove(this)
                }
            }, {
                key: "init",
                value: function(n) {
                    this.deg = n.deg, c.player.setDeg(this.deg), c.player.setTarget(n), this.x += Math.sin(this.deg) * (c.player.y - this.y) + 2, this.y -= c.player.y - this.y - Math.cos(this.deg) * (c.player.y - this.y)
                }
            }]) && x(t.prototype, e), i && x(t, i), Object.defineProperty(t, "prototype", {
                writable: !1
            }), n
        }();
        ...
        function k(n, t) {
            for (var e = 0; e < t.length; e++) {
                ...
                i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(n, (o = i.key, r = void 0, r = function(n, t) {
                    ...
                    return ("string" === t ? String : Number)(n)
                }(o, "string"), "symbol" === w(r) ? r : String(r)), i)
            }
            var o, r
        }
        var q = function() {
            ...
            return t = n, (e = [{
                ...
                key: "resetPosAndSize",
                value: function() {
                    null != this.size && (this.pos.constructor == Function ? this.size(this) : (this.w = this.size[this.index][0], this.h = this.size[this.index][1])), null != this.pos && (this.pos.constructor == Function ? this.pos(this) : (this.x = this.pos[this.index][0], this.y = this.pos[this.index][1]))
                }
            }]) && k(t.prototype, e), i && k(t, i), Object.defineProperty(t, "prototype", {
                writable: !1
            }), n
        }();
        ...
        var L = function() {
            function n() {
                ! function(n, t) {
                    if (!(n instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, n), this.w = 51, this.h = 75, this.x = g.gameWidth / 2, this.y = g.gameHeight - this.h / 2 - 15, this.drawx = this.x - this.w / 2, this.drawy = this.y - this.h / 2, this.img = i, this.err_img = d(), this.err_i = -1, this.deg = 0, this.target = null, this.letterNum = 0, this.score = 0;
                var t = localStorage.getItem("_typeBestScore");
                this.setBestScore(t ? parseInt(t) : 0), this.protect = 3, this.isClear = !1, this.clearPer = 10, this.clearIndex = 0, this.clearMax = c.canvas.hei() / 2, this.tailY = this.y + this.h / 2 - 6, this.fireAni = new q({
                    ctx: c.ctx,
                    host: this,
                    img: u,
                    pos: function(n) {
                        n.y = n.host.tailY + n.h / 2
                    },
                    size: function(n) {
                        n.h = 13 + 2 * (n.max - 1 - n.index)
                    },
                    x: this.x + .3,
                    y: this.tailY + 6,
                    w: 11,
            ...
            return t = n, (e = [{
                key: "act",
                value: function() {
                    if (this.isClear && !c.isStop && !c.isPause) {
                        this.clearIndex += this.clearPer;
                        var n = this;
                        c.enemys.each((function(t) {
                            t.y + t.h / 2 > n.y - n.h / 2 - n.clearIndex && !t.isDie && t.die()
                        })), this.clearIndex > this.clearMax && (this.isClear = !1, this.clearIndex = 0)
                    }
                    this.draw(), c.isStop || c.isPause || this.fireAni.act(), this.err_i >= 0 && (this.err_i++, this.err_i > d().length - 1 && (this.err_i = -1))
                }
            }, {
                key: "draw",
                value: function() {
                    this.isClear && (c.ctx.fillStyle = "#fff", c.ctx.fillRect(0, this.y - this.h / 2 - this.clearIndex, g.gameWidth, 2)), c.ctx.save(), c.ctx.translate(this.x, this.y), c.ctx.rotate(this.deg), c.ctx.translate(-this.x, -this.y), this.err_i > -1 ? c.ctx.drawImage(this.err_img[this.err_i], this.x - this.w / 2, this.y - this.h / 2, this.w, this.h) : c.ctx.drawImage(this.img, this.x - this.w / 2, this.y - this.h / 2, this.w, this.h), this.fireAni.draw(), c.ctx.restore()
                }
            }, {
                key: "resetPos",
                value: function() {
                    this.x = g.gameWidth / 2, this.y = g.gameHeight - this.h / 2 - 15, this.drawx = this.x - this.w / 2, this.drawy = this.y - this.h / 2, this.tailY = this.y + this.h / 2 - 6, this.fireAni.x = this.x + .3, this.fireAni.y = this.tailY + 6
                }
            }, {
                key: "setErr",
                value: function() {
                ...
                key: "clear",
                value: function() {
                    this.isClear || c.isStop || c.isPause || this.setProtect() && (this.isClear = !0)
                }
            }, {
                key: "die",
                value: function() {
                ...
                key: "setLetterNum",
                value: function(n) {
                    null == n ? this.letterNum++ : this.letterNum = n, l.a.id("letterNum").txt(this.letterNum)
                }
            }, {
                key: "setScore",
                value: function(n) {
                    null == n ? this.score++ : this.score = n, l.a.id("score").txt(this.score), this.score > this.bestScore && this.setBestScore(this.score)
                }
            }, {
                key: "setBestScore",
                value: function(n) {
                    this.bestScore = n, l.a.id("bestScore").txt(n), localStorage.setItem("_typeBestScore", n)
                }
            }, {
                key: "setProtect",
                value: function(n) {
                    if (null == n) {
                        if (this.protect > 0) return this.protect--, l.a.id("protect").txt(this.protect), !0;
                        this.setErr(), m("護盾已用完", !0, 1e3)
                    } else this.protect = n, l.a.id("protect").txt(this.protect);
                    return !1
                }
            }, {
                key: "restart",
                value: function() {
                    this.setLetterNum(0), this.setScore(0), this.setProtect(3), this.err_i = -1, this.deg = 0, this.target = null, this.isClear = !1, this.clearIndex = 0
                }
            }]) && T(t.prototype, e), o && T(t, o), Object.defineProperty(t, "prototype", {
                writable: !1
            }), n
        }();
        ...
        var A = [
            ...
            O = function() {
                function n(t, e, i) {
                    ! function(n, t) {
                        if (!(n instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, n), this.speed = M, this.type = l.a.checkArg(i, l.a.random(0, 3)), this.w = I[this.type].w, this.h = I[this.type].h, this.x = l.a.checkArg(t, l.a.random(0, g.gameWidth)), this.y = l.a.checkArg(e, -this.h), this.words = A[this.type][l.a.random(0, A[this.type].length - 1)], this.question = questionBank['level' + (this.type + 1)].find(q => q.word === this.words), this.bopomofo = this.question ? this.question.bopomofo.replace(/\s/g, '') : '', this.hp = this.bopomofo.length, this.hpBarW = 4 * this.hp, this.index = 0, this.img = r[this.type], this.deg = -Math.atan((this.x - c.player.x) / (this.y - c.player.y)), 0 == this.type ? this.speed += .2 : 3 == this.type && (this.sendMax = 15e3, this.sendIndex = 0), this.dieImg = f(), this.isDie = !1, this.dieIndex = -1, this.dieLen = 100, this.isRemove = !1
                }
                var t, e, i;
                return t = n, (e = [{
                    key: "act",
                    value: function() {
                        this.isRemove || (this.isDie ? (this.dieIndex++, this.dieIndex >= this.dieImg.length && (this.dieIndex--, this.remove())) : (3 == this.type && (this.sendIndex += p, this.sendIndex > this.sendMax && (this.sendIndex = 0, c.enemys.insert(new n(this.x, this.y, 0), c.enemys.indexOf(this) + 1))), this.x -= this.speed * Math.sin(this.deg), this.y += this.speed * Math.cos(this.deg), this.touchTarget() && c.player.die()), this.draw())
                    }
                }, {
                    key: "draw",
                    value: function() {
                        if (c.ctx.save(), c.ctx.translate(this.x, this.y), c.ctx.rotate(this.deg), c.ctx.translate(-this.x, -this.y), this.isDie) c.ctx.drawImage(this.dieImg[this.dieIndex], this.x - this.dieLen / 2, this.y - this.dieLen / 2, this.dieLen, this.dieLen);
                        else {
                            c.ctx.font = "20px MicrosoftYahei";
                            var n = this.y - this.h / 2;
                            c.ctx.drawImage(this.img, this.x - this.w / 2, n, this.w, this.h), c.ctx.fillText(this.words, this.x, n - 8), c.ctx.fillStyle = "#f44", n += this.h, c.ctx.fillRect(this.x - this.hpBarW / 2, n + 4, this.hpBarW, 3), c.ctx.fillText(this.bopomofo.substring(0, this.bopomofo.length - this.hp), this.x, n + 20), c.ctx.fillStyle = "#4f4", c.ctx.fillRect(this.x - this.hpBarW / 2, n + 4, 4 * this.hp, 3)
                        }
                        c.ctx.restore()
                    }
                }, {
                    key: "hurt",
                    value: function() {
                        this.hp--, this.x += this.speed * Math.sin(this.deg) * 3, this.y -= this.speed * Math.cos(this.deg) * 3, 0 == this.hp && this.die()
                    }
                }, {
                    key: "touchTarget",
                    value: function() {
                        return this.y + this.h / 2 > c.player.y - c.player.h / 2
                    }
                }, {
                    key: "die",
                    value: function() {
                    ...
                    key: "remove",
                    value: function() {
                        this.isRemove = !0, c.player.setScore(), c.enemys.remove(this), c.enemys.sortByAttr("y", !1)
                    }
                }, {
                    key: "check",
                    value: function(n) {
                        return this.index < this.bopomofo.length && n == this.bopomofo[this.index] && (this.index++, !0)
                    }
                }, {
                    key: "resetDeg",
                    value: function() {
                        this.deg = -Math.atan((this.x - c.player.x) / (this.y - c.player.y))
                    }
                }]) && N(t.prototype, e), i && N(t, i), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), n
            }(),
            W = e(1),
        ...
        function V() {
            g.gameWidth = l.a.id("gameWrapper").wid(), g.gameHeight = l.a.height(), l.a.isMobile() ? (l.a.id("keyboard").css("display", "block"), g.gameHeight -= l.a.id("keyboard").hei()) : l.a.id("keyboard").css("display", "none"), c.canvas.width = g.gameWidth, c.canvas.height = g.gameHeight
        }
        _.a.use(X.a), window.J = l.a, l.a.ready((function() {
            l.a.isMobile() && (z = 15, function(n, t) {
                    M = n, t && (E = t)
                }(.3, 1.5), c.addEnemyTime = 1e4), c.canvas = l.a.id("gameCanvas"), V(), c.ctx = c.canvas.getContext("2d"), c.ctx.fillStyle = "#fff", c.ctx.textBaseline = "middle", c.ctx.textAlign = "center",
                function() {
                    (i = new Image).src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/player.png", o = new Array;
                    for (var n = 0; n < 2; n++) o[n] = new Image, o[n].src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/player_err" + (n + 1) + ".png";
                    o[2] = o[1], o[3] = o[1], o[4] = o[1], o[5] = o[0], r = new Array;
                    for (var t = 0; t < 4; t++) r[t] = new Image, r[t].src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/enemy" + (t + 1) + ".png";
                    s = new Array;
                    for (var e = 0; e < 4; e++) s[e] = new Image, s[e].src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/bomb" + (e + 1) + ".png";
                    u = new Array;
                    for (var a = 0; a < 3; a++) u[a] = new Image, u[a].src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/tail" + a + ".png";
                    u[3] = u[1], u[4] = u[0], (h = new Image).src = "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/bullet.png"
                }(), c.player = new L, c.enemys = new Array, c.bullets = new Array, window._clear = function() {
                    c.player.clear()
                }, l.a.id("protect").clk("_clear()"), window._pause = function() {
                    B()
                }, l.a.id("pause").clk("_pause()"), window._restart = function() {
                    F()
                }, l.a.id("restart").clk("_restart()"), window._sendBullet = function(n) {
                    J(n)
                }, l.a.cls("key-item").clk("_sendBullet(this.txt())"), l.a.id("help").clk('J.id("helpPage").fadeIn()'), l.a.id("github").clk((function() {
                    l.a.open("https://github.com/theajack/type")
                })), l.a.id("helpPage").clk("this.fadeOut()"), c.bgMoveAni = new q({
                    ctx: c.ctx,
                    host: l.a.id("background"),
                    max: l.a.id("background").hei() / 2,
                    per: .3,
                    singleCall: function(n) {
                        n.host.css("bottom", -n.index + "px")
                    }
                }), D(), c.enemys.append(new O), setInterval((function() {
                    c.isStop || c.isPause || c.enemys.append(new O)
                }), c.addEnemyTime)
        }));
        var D = window.requestAnimationFrame ? function() {
        ...
        function R() {
            c.isStop || c.isPause || (c.ctx.clearRect(0, 0, g.gameWidth, g.gameHeight), c.player.act(), c.enemys.each((function(n) {
                n.act()
            })), c.bullets.each((function(n) {
                n.act()
            }))), c.bgMoveAni.act(), c.loopIndex++, M >= E || c.loopIndex % 200 == 0 && (M += .05)
        }

        function B() {
            c.isStop || (c.isPause ? (c.isPause = !1, l.a.id("pause").child(0).attr("src", "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/pause.png"), j()) : (c.isPause = !0, l.a.id("pause").child(0).attr("src", "https://cdn.jsdelivr.net/gh/theajack/type/docs/images/start.png"), m("暂停中")))
        }

        function J(n) {
            c.enemys.length > 0 ? c.bullets.append(new v(n)) : (m("没有找到目标", !0, 1e3), c.player.setErr())
        }

        function F() {
            c.isStop = !1, c.isPause && B(), c.loopIndex = 0, c.enemys.empty(), c.bullets.empty(), c.player.restart(), H(), j()
        }
        window.onkeydown = function(n) {
            var t = n.keyCode;
            var key = n.key.toLowerCase();
            53 == t ? F() : c.isStop || 32 != t ? c.isStop || c.isPause || (bopomofoKeyboard.isValidKey(key) ? J(bopomofoKeyboard.keyToBopomofo(key)) : 13 == t ? c.player.clear() : (m("按鍵錯誤", !0, 1e3), c.player.setErr())) : B()
        }, window.onresize = function() {
            V(), c.ctx.fillStyle = "#fff", c.ctx.textBaseline = "middle", c.ctx.textAlign = "center", c.player.resetPos(), c.enemys.each((function(n) {
                n.resetDeg()
            }))
        };
        t.default = {}
    }])
}));// 請在這裡貼上解壓縮後的 game.min.js 代碼
// 解壓縮後的代碼會在這裡
